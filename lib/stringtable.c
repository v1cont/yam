...
static StringEntry *
string_entry_new (const gchar * str)
{
  StringEntry *entry;
...
static void
string_entry_free (StringEntry * entry)
{
...
gchar *
string_table_lookup_string (StringTable * table, const gchar * str)
{
  StringEntry *entry;
...
gchar *
string_table_insert_string (StringTable * table, const gchar * str)
{
  StringEntry *entry;
...
void
string_table_free_string (StringTable * table, const gchar * str)
{
  StringEntry *entry;
...
static gboolean
string_table_remove_for_each_fn (gchar * key, StringEntry * entry, gpointer user_data)
{
...
void
string_table_free (StringTable * table)
{
...
static void
string_table_stats_for_each_fn (gchar * key, StringEntry * entry, guint * totals)
{
...
void
string_table_get_stats (StringTable * table)
{
  guint totals = 0;
