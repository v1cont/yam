...
void procmime_scan_content_type_partial (const gchar * content_type, gint * total, gchar ** part_id, gint * number);
...
gint procmime_get_part (const gchar * outfile, const gchar * infile, MimeInfo * mimeinfo);
...
gint procmime_get_all_parts (const gchar * dir, const gchar * infile, MimeInfo * mimeinfo);
FILE *procmime_get_text_content (MimeInfo * mimeinfo, FILE * infp, const gchar * encoding);
...
gboolean procmime_find_string_part (MimeInfo * mimeinfo,
                                    const gchar * filename, const gchar * str, StrFindFunc find_func);
gboolean procmime_find_string (MsgInfo * msginfo, const gchar * str, StrFindFunc find_func);
