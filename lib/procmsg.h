...
typedef FILE *(*DecryptMessageFunc) (MsgInfo * msginfo, MimeInfo ** mimeinfo);
...
GSList *procmsg_sort_msg_list (GSList * mlist, FolderSortKey sort_key, FolderSortType sort_type);
...
FILE *procmsg_open_data_file (const gchar * file, guint version, DataOpenMode mode, gchar * buf, size_t buf_size);
...
gint procmsg_add_messages_from_queue (FolderItem * dest, GSList * mlist, gboolean is_move);
...
void procmsg_print_message (MsgInfo * msginfo, const gchar * cmdline, gboolean all_headers);
void procmsg_print_message_part (MsgInfo * msginfo, MimeInfo * partinfo, const gchar * cmdline, gboolean all_headers);

gint procmsg_save_message_as_text (MsgInfo * msginfo, const gchar * dest, const gchar * encoding, gboolean all_headers);
