...
guint sock_add_watch_poll (SockInfo * sock, GIOCondition condition, SockFunc func, gpointer data);
...
gint sock_info_connect_async (SockInfo * sock, SockConnectFunc func, gpointer data);
