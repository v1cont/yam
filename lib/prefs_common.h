...
struct _PrefsCommon {
  ...
  gint folderwin_x;
  gint folderwin_y;
  gint folderwin_width;
  gint folderwin_height;
  ...
  gint folderview_paned;
  gint summaryview_hpaned;
  gint summaryview_vpaned;
  ...
  gchar *quote_level1_col;
  gchar *quote_level2_col;
  gchar *quote_level3_col;
  gchar *uri_col;
  gchar *sig_col;
...
void prefs_common_junk_folder_rename_path (const gchar * old_path, const gchar * new_path);
