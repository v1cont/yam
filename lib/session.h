...
struct _Session {
  ...
  /* virtual methods to parse server responses */
    ...
    gint (*recv_data_as_file_finished) (Session * session, FILE * fp, guint len);
...
gint session_connect_full (Session * session, const gchar * server, gushort port, SocksInfo * socks_info);
