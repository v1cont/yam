...
gint procheader_get_one_field (gchar * buf, size_t len, FILE * fp, HeaderEntry hentry[]);
...
GSList *procheader_add_header_list (GSList * hlist, const gchar * header_name, const gchar * body);
...
GPtrArray *procheader_get_header_array_for_display (FILE * fp, const gchar * encoding);
