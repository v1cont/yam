...
typedef gboolean (*FolderUIFunc2) (Folder * folder, FolderItem * item, guint count, guint total, gpointer data);
...
struct _FolderClass {
  ...
  /* virtual functions */
  Folder *(*folder_new) (const gchar * name, const gchar * path);
  void (*destroy) (Folder * folder);

    gint (*scan_tree) (Folder * folder);
    gint (*create_tree) (Folder * folder);

  GSList *(*get_msg_list) (Folder * folder, FolderItem * item, gboolean use_cache);
  GSList *(*get_uncached_msg_list) (Folder * folder, FolderItem * item);
  ...
  MsgInfo *(*get_msginfo) (Folder * folder, FolderItem * item, gint num);
    gint (*add_msg) (Folder * folder, FolderItem * dest, const gchar * file, MsgFlags * flags, gboolean remove_source);
    gint (*add_msgs) (Folder * folder, FolderItem * dest, GSList * file_list, gboolean remove_source, gint * first);
    gint (*add_msg_msginfo) (Folder * folder, FolderItem * dest, MsgInfo * msginfo, gboolean remove_source);
    gint (*add_msgs_msginfo) (Folder * folder,
                              FolderItem * dest, GSList * msginfo_list, gboolean remove_source, gint * first);
    gint (*move_msg) (Folder * folder, FolderItem * dest, MsgInfo * msginfo);
    gint (*move_msgs) (Folder * folder, FolderItem * dest, GSList * msglist);
    gint (*copy_msg) (Folder * folder, FolderItem * dest, MsgInfo * msginfo);
    gint (*copy_msgs) (Folder * folder, FolderItem * dest, GSList * msglist);
    gint (*remove_msg) (Folder * folder, FolderItem * item, MsgInfo * msginfo);
    gint (*remove_msgs) (Folder * folder, FolderItem * item, GSList * msglist);
    ...
    gint (*scan) (Folder * folder, FolderItem * item);
  ...
  FolderItem *(*create_folder) (Folder * folder, FolderItem * parent, const gchar * name);
    ...
    gint (*move_folder) (Folder * folder, FolderItem * item, FolderItem * new_parent);
...
gboolean folder_call_ui_func2 (Folder * folder, FolderItem * item, guint count, guint total);
...
gint folder_item_add_msgs (FolderItem * dest, GSList * file_list, gboolean remove_source, gint * first);
gint folder_item_add_msg_msginfo (FolderItem * dest, MsgInfo * msginfo, gboolean remove_source);
gint folder_item_add_msgs_msginfo (FolderItem * dest, GSList * msginfo_list, gboolean remove_source, gint * first);
