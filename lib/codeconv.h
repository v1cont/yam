...
CodeConverter *conv_code_converter_new (const gchar * src_encoding, const gchar * dest_encoding);
...
gchar *conv_codeset_strdup_full (const gchar * inbuf,
                                 const gchar * src_encoding, const gchar * dest_encoding, gint * error);

CodeConvFunc conv_get_code_conv_func (const gchar * src_encoding, const gchar * dest_encoding);

gchar *conv_iconv_strdup (const gchar * inbuf, const gchar * src_encoding, const gchar * dest_encoding, gint * error);
...
void conv_encode_header (gchar * dest,
                         gint len, const gchar * src, gint header_len, gboolean addr_field, const gchar * out_encoding);
gchar *conv_encode_filename (const gchar * src, const gchar * param_name, const gchar * out_encoding);

gint conv_copy_file (const gchar * src, const gchar * dest, const gchar * src_encoding);
gint conv_copy_dir (const gchar * src, const gchar * dest, const gchar * src_encoding);
