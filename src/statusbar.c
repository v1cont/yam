...
void
statusbar_puts (GtkStatusbar * statusbar, const gchar * str)
{
  gint cid;
  gchar *buf;
...
void
statusbar_puts_all (const gchar * str)
{
  GList *cur;
...
void
statusbar_print (GtkStatusbar * statusbar, const gchar * format, ...)
{
  va_list args;
  gchar buf[BUFFSIZE];
...
void
statusbar_print_all (const gchar * format, ...)
{
  va_list args;
  gchar buf[BUFFSIZE];
  GList *cur;
