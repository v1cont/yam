...
*/
void
vcard_set_name (VCardFile * cardFile, const gchar * value)
{
...
void
vcard_set_file (VCardFile * cardFile, const gchar * value)
{
  g_return_if_fail (cardFile != NULL);
...
void
vcard_set_accessed (VCardFile * cardFile, const gboolean value)
{
  g_return_if_fail (cardFile != NULL);
...
*/
gboolean
vcard_get_modified (VCardFile * vcardFile)
{
...
gboolean
vcard_get_accessed (VCardFile * vcardFile)
{
  g_return_val_if_fail (vcardFile != NULL, FALSE);
  return addrcache_check_file (vcardFile->addressCache, vcardFile->path);
}
...
*/
gboolean
vcard_get_read_flag (VCardFile * vcardFile)
{
  g_return_val_if_fail (vcardFile != NULL, FALSE);
...
*/
gint
vcard_get_status (VCardFile * cardFile)
{
...
ItemFolder *
vcard_get_root_folder (VCardFile * cardFile)
{
...
gchar *
vcard_get_name (VCardFile * cardFile)
{
  g_return_val_if_fail (cardFile != NULL, NULL);
...
*/
void
vcard_force_refresh (VCardFile * cardFile)
{
  addrcache_refresh (cardFile->addressCache);
}
...
*/
VCardFile *
vcard_create_path (const gchar * path)
{
  VCardFile *cardFile;
...
*/
void
vcard_free (VCardFile * cardFile)
{
  g_return_if_fail (cardFile != NULL);

  /* Close file */
  if (cardFile->file)
    fclose (cardFile->file);
...
*/
void
vcard_print_file (VCardFile * cardFile, FILE * stream)
{
  g_return_if_fail (cardFile != NULL);
...
*/
static gint
vcard_open_file (VCardFile * cardFile)
{
  g_return_val_if_fail (cardFile != NULL, -1);
...
*/
static void
vcard_close_file (VCardFile * cardFile)
{
  g_return_if_fail (cardFile != NULL);
  if (cardFile->file)
    fclose (cardFile->file);
...
*/
static gchar *
vcard_read_line (VCardFile * cardFile)
{
...
*/
static gchar *
vcard_get_line (VCardFile * cardFile)
{
...
*/
static void
vcard_free_lists (GSList * listName, GSList * listAddr, GSList * listRem, GSList * listID)
{
...
*/
static gchar *
vcard_read_qp (VCardFile * cardFile, gchar * tagvalue)
{
  GSList *listQP = NULL;
  gint len = 0;
  gchar *line = tagvalue;
...
*/
static gchar *
vcard_get_tagname (gchar * line, gchar dlm)
{
  gint len = 0;
  gchar *tag = NULL;
  gchar *lptr = line;
...
*/
static gchar *
vcard_get_tagvalue (gchar * line, gchar dlm)
{
  gchar *value = NULL;
  gchar *start = NULL;
  gchar *lptr;
...
*/
static void
vcard_dump_lists (GSList * listName, GSList * listAddr, GSList * listRem, GSList * listID, FILE * stream)
{
...
*/
static void
vcard_build_items (VCardFile * cardFile, GSList * listName, GSList * listAddr, GSList * listRem, GSList * listID)
{
...
*/
static void
vcard_read_file (VCardFile * cardFile)
{
  ...
  for (;;)
    {
      ...
      if (g_ascii_strcasecmp (tagname, VCARD_TAG_START) == 0 && g_ascii_strcasecmp (tagvalue, VCARD_NAME) == 0)
        {
      ...
      if (g_ascii_strcasecmp (tagname, VCARD_TAG_END) == 0 && g_ascii_strcasecmp (tagvalue, VCARD_NAME) == 0)
        {
          /* vCard is complete */
...
/* ============================================================================================ */
gint
vcard_read_data (VCardFile * cardFile)
{
  g_return_val_if_fail (cardFile != NULL, -1);
...
*/
GList *
vcard_get_list_person (VCardFile * cardFile)
{
  g_return_val_if_fail (cardFile != NULL, NULL);
...
*/
GList *
vcard_get_list_folder (VCardFile * cardFile)
{
  g_return_val_if_fail (cardFile != NULL, NULL);
  return NULL;
}
...
*/
GList *
vcard_get_all_persons (VCardFile * cardFile)
{
  g_return_val_if_fail (cardFile != NULL, NULL);
...
*/
gboolean
vcard_validate (const VCardFile * cardFile)
{
  gboolean retVal;
...
*/
gint
vcard_test_read_file (const gchar * fileSpec)
{
  gboolean haveStart;
