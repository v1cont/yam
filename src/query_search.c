...
static FilterRule *query_search_dialog_to_rule (const gchar * name, FolderItem ** item);
...
static gboolean treeview_button_pressed (GtkWidget * widget, GdkEventButton * event, gpointer data);
...
static gint query_search_deleted (GtkWidget * widget, GdkEventAny * event, gpointer data);
...
static gint query_search_cmp_by_folder (GtkTreeModel * model, GtkTreeIter * a, GtkTreeIter * b, gpointer data);
static gint query_search_cmp_by_subject (GtkTreeModel * model, GtkTreeIter * a, GtkTreeIter * b, gpointer data);
static gint query_search_cmp_by_from (GtkTreeModel * model, GtkTreeIter * a, GtkTreeIter * b, gpointer data);
static gint query_search_cmp_by_date (GtkTreeModel * model, GtkTreeIter * a, GtkTreeIter * b, gpointer data);

void
query_search (FolderItem * item)
{
  gchar *id;
...
create_search_popup_menu (void)
{
  ...
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (reply_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);

  item = gtk_menu_item_new_with_mnemonic (_("Repl_y to"));
  gtk_widget_show (item);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
  ...
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (reply_all_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (submenu), item);

  item = gtk_menu_item_new_with_mnemonic (("Reply to _sender"));
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (reply_sender_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (submenu), item);

  item = gtk_menu_item_new_with_mnemonic (_("Reply to _list"));
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (reply_list_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (submenu), item);
  ...
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (forward_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);

  item = gtk_menu_item_new_with_mnemonic (_("For_ward as attachment"));
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (forward_attach_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);

  item = gtk_menu_item_new_with_mnemonic (_("Redirec_t"));
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (redirect_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
  ...
  item = gtk_menu_item_new_with_mnemonic (_("M_ove messages to..."));
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (move_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);

  item = gtk_menu_item_new_with_mnemonic (_("_Copy messages to..."));
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (copy_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
  ...
  item = gtk_menu_item_new_with_mnemonic (_("Add sender to address boo_k..."));
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (add_address_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);

  item = gtk_menu_item_new_with_mnemonic (_("Create f_ilter rule"));
  gtk_widget_show (item);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
  ...
  item = gtk_menu_item_new_with_mnemonic (_("_Automatically"));
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (create_filter_auto_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (submenu), item);

  item = gtk_menu_item_new_with_mnemonic (("by _From"));
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (create_filter_from_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (submenu), item);

  item = gtk_menu_item_new_with_mnemonic (_("by _To"));
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (create_filter_to_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (submenu), item);

  item = gtk_menu_item_new_with_mnemonic (_("by _Subject"));
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (create_filter_subject_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (submenu), item);
  ...
  item = gtk_menu_item_new_with_mnemonic (_("Open in _new window"));
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (open_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);

  item = gtk_menu_item_new_with_mnemonic (_("View mess_age source"));
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (open_source_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
  ...
  gtk_widget_show (item);
  g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (print_cb), NULL);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
...
query_search_create (void)
{
  ...
  g_signal_connect (G_OBJECT (window), "delete_event", G_CALLBACK (query_search_deleted), NULL);
  ...
  bool_hbox = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 12);
  gtk_widget_show (bool_hbox);
  gtk_box_pack_start (GTK_BOX (vbox1), bool_hbox, FALSE, FALSE, 0);

  bool_optmenu = gtk_combo_box_text_new ();
  gtk_widget_show (bool_optmenu);
  gtk_box_pack_start (GTK_BOX (bool_hbox), bool_optmenu, FALSE, FALSE, 0);

  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (bool_optmenu), _("Match any of the following"));
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (bool_optmenu), _("Match all of the following"));
  gtk_combo_box_set_active (GTK_COMBO_BOX (bool_optmenu), FLT_AND);
  ...
  clear_btn = yam_button_new ("yam-clear");
  gtk_widget_show (clear_btn);
  gtk_box_pack_start (GTK_BOX (hbbox), clear_btn, FALSE, FALSE, 0);

  search_btn = yam_button_new ("yam-find");
  ...
  gtk_container_add (GTK_CONTAINER (scrolledwin), cond_edit->cond_vbox);
  ...
  folder_hbox = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 8);
  ...
  checkbtn_hbox = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 12);
  gtk_widget_show (checkbtn_hbox);
  gtk_box_pack_start (GTK_BOX (vbox1), checkbtn_hbox, FALSE, FALSE, 0);

  subfolder_checkbtn = gtk_check_button_new_with_label (_("Search subfolders"));
  gtk_widget_show (subfolder_checkbtn);
  gtk_box_pack_start (GTK_BOX (checkbtn_hbox), subfolder_checkbtn, FALSE, FALSE, 0);
  ...
  store = gtk_list_store_new (N_COLS, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_POINTER);
  treeview = gtk_tree_view_new_with_model (GTK_TREE_MODEL (store));
  g_object_unref (store);
  g_signal_connect (G_OBJECT (treeview), "row-activated", G_CALLBACK (row_activated), NULL);
  g_signal_connect (G_OBJECT (treeview), "button-press-event", G_CALLBACK (treeview_button_pressed), NULL);

  gtk_tree_sortable_set_sort_func (GTK_TREE_SORTABLE (store), COL_FOLDER, query_search_cmp_by_folder, NULL, NULL);
  gtk_tree_sortable_set_sort_func (GTK_TREE_SORTABLE (store), COL_SUBJECT, query_search_cmp_by_subject, NULL, NULL);
  gtk_tree_sortable_set_sort_func (GTK_TREE_SORTABLE (store), COL_FROM, query_search_cmp_by_from, NULL, NULL);
  gtk_tree_sortable_set_sort_func (GTK_TREE_SORTABLE (store), COL_DATE, query_search_cmp_by_date, NULL, NULL);

  selection = gtk_tree_view_get_selection (GTK_TREE_VIEW (treeview));
  gtk_tree_selection_set_mode (selection, GTK_SELECTION_MULTIPLE);
  gtk_tree_selection_set_select_function (selection, row_selected, NULL, NULL);
...
#define APPEND_COLUMN(label, col, width)                            \
  ...
  confirm_area = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 12);
  gtk_widget_show (confirm_area);
  gtk_box_pack_start (GTK_BOX (vbox1), confirm_area, FALSE, FALSE, 0);

  status_label = gtk_label_new (NULL);
  gtk_widget_show (status_label);
  gtk_box_pack_start (GTK_BOX (confirm_area), status_label, FALSE, FALSE, 0);

  btn_hbox = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 6);
  gtk_widget_show (btn_hbox);
  gtk_box_pack_end (GTK_BOX (confirm_area), btn_hbox, FALSE, FALSE, 0);

  yam_stock_button_set_create (&hbbox, &close_btn, "yam-close", NULL, NULL, NULL, NULL);
  gtk_widget_show (hbbox);
  ...
  g_signal_connect (G_OBJECT (clear_btn), "clicked", G_CALLBACK (query_search_clear), NULL);
  g_signal_connect (G_OBJECT (folder_btn), "clicked", G_CALLBACK (query_select_folder), NULL);
  g_signal_connect (G_OBJECT (search_btn), "clicked", G_CALLBACK (query_search_clicked), NULL);
  g_signal_connect (G_OBJECT (save_btn), "clicked", G_CALLBACK (query_search_save), NULL);
  g_signal_connect (G_OBJECT (close_btn), "clicked", G_CALLBACK (query_search_close), NULL);
  ...
  search_window.popup = create_search_popup_menu ();
}

static FilterRule *
query_search_dialog_to_rule (const gchar * name, FolderItem ** item)
{
  const gchar *id;
  FolderItem *item_;
  ...
  bool_op = gtk_combo_box_get_active (GTK_COMBO_BOX (search_window.bool_optmenu));
  recursive = gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (search_window.subfolder_checkbtn));
  case_sens = gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (search_window.case_checkbtn));

  cond_list = prefs_filter_edit_cond_edit_to_list (search_window.cond_edit, case_sens);
  if (!cond_list)
    return NULL;
...
query_search_query (void)
{
  ...
  search_window.requires_full_headers = filter_rule_requires_full_headers (search_window.rule);
  ...
  gtk_button_set_label (GTK_BUTTON (search_window.search_btn), _("_Stop"));
  query_search_clear_list ();

  if (search_window.rule->recursive)
    g_node_traverse (item->node, G_PRE_ORDER, G_TRAVERSE_ALL, -1, query_search_recursive_func, NULL);
  else
  ...
  gtk_button_set_label (GTK_BUTTON (search_window.search_btn), _("_Find"));
  if (search_window.n_found == 0)
    ...
    msg = g_strdup_printf (_("%d messages found."), search_window.n_found);
...
static void
query_search_folder_show_progress (const gchar * name, gint count, gint total)
{
  gchar *str;

  str = g_strdup_printf (_("Searching %s (%d / %d)..."), name, count, total);
  gtk_label_set_text (GTK_LABEL (search_window.status_label), str);
  g_free (str);
}

static gboolean
query_search_progress_func (gpointer data)
{
  QueryData *qdata = (QueryData *) data;
  MsgInfo *msginfo;

  gdk_threads_enter ();
  query_search_folder_show_progress (qdata->folder_name, g_atomic_int_get (&qdata->count), qdata->total);
...
static gpointer
query_search_folder_func (gpointer data)
{
  QueryData *qdata = (QueryData *) data;
  GSList *mlist, *cur;
  FilterInfo fltinfo;
  ...
  for (cur = mlist; cur != NULL; cur = cur->next)
    {
      ...
      if (tv_cur - qdata->tv_prev > PROGRESS_UPDATE_INTERVAL * 1000)
      ...
      if (filter_match_rule (search_window.rule, msginfo, hlist, &fltinfo))
        {
...
static void
query_search_folder (FolderItem * item)
{
  gchar *str;
  QueryData data = { item };
  GThread *thread;
  ...
  gtk_label_set_text (GTK_LABEL (search_window.status_label), str);
  g_free (str);
  data.tv_prev = g_get_monotonic_time ();
  ...
  data.timer_tag = g_timeout_add (PROGRESS_UPDATE_INTERVAL, query_search_progress_func, &data);
  thread = g_thread_new ("search", query_search_folder_func, &data);
...
static gboolean
query_search_recursive_func (GNode * node, gpointer data)
{
  FolderItem *item;
...
static void
query_search_append_msg (MsgInfo * msginfo)
{
  ...
  if (msginfo->date_t)
    {
      procheader_date_get_localtime (date_buf, sizeof (date_buf), msginfo->date_t);
      date = date_buf;
    }
  ...
  gtk_list_store_set (store, &iter, COL_FOLDER, folder, COL_SUBJECT, subject,
                      COL_FROM, from, COL_DATE, date, COL_MSGINFO, msginfo, -1);

  g_free (folder);
}

static void
query_search_clear_list (void)
{
  GtkTreeIter iter;
  GtkTreeModel *model = GTK_TREE_MODEL (search_window.store);
  MsgInfo *msginfo;

  yam_tree_sortable_unset_sort_column_id (GTK_TREE_SORTABLE (search_window.store));
...
static void
query_search_hbox_added (CondHBox * hbox)
{
  g_signal_connect (hbox->key_entry, "activate", G_CALLBACK (query_search_entry_activated), NULL);
}

static void
row_activated (GtkTreeView * treeview, GtkTreePath * path, GtkTreeViewColumn * column, gpointer data)
{
  query_search_open_msg (FALSE);
}

static gboolean
row_selected (GtkTreeSelection * selection,
              GtkTreeModel * model, GtkTreePath * path, gboolean cur_selected, gpointer data)
{
  return TRUE;
}
...
static gboolean
treeview_button_pressed (GtkWidget * widget, GdkEventButton * event, gpointer data)
{
  GtkTreeIter iter;
  GtkTreeModel *model = GTK_TREE_MODEL (search_window.store);
  GtkTreeSelection *selection;
  ...
  if (event->button == 3)
    {
      gtk_menu_popup_at_pointer (GTK_MENU (search_window.popup), (GdkEvent *) event);
      if (is_selected)
        return TRUE;
    }
...
static void
query_search_clear (GtkButton * button, gpointer data)
{
  CondHBox *cond_hbox;
  ...
  prefs_filter_edit_set_cond_hbox_widgets (cond_hbox, PF_COND_HEADER);
  prefs_filter_edit_insert_cond_hbox (search_window.cond_edit, cond_hbox, -1);
...
static void
query_select_folder (GtkButton * button, gpointer data)
{
  FolderItem *item;
  gchar *id;
...
static void
query_search_clicked (GtkButton * button, gpointer data)
{
  if (search_window.on_search)
...
static gint
query_search_save_dialog_deleted (GtkWidget * widget, GdkEventAny * event, gpointer data)
{
...
static gint
query_search_save_dialog_key_pressed (GtkWidget * widget, GdkEventKey * event, gpointer data)
{
  QuerySearchSaveDialog *dialog = (QuerySearchSaveDialog *) data;
...
static void
query_search_save_dialog_select_folder (GtkButton * button, gpointer data)
{
  QuerySearchSaveDialog *dialog = (QuerySearchSaveDialog *) data;
  FolderItem *item;
  gchar *id;
...
static void
query_search_save_activated (GtkEditable * editable, gpointer data)
{
  QuerySearchSaveDialog *dialog = (QuerySearchSaveDialog *) data;
...
static void
query_search_save_ok (GtkButton * button, gpointer data)
{
  QuerySearchSaveDialog *dialog = (QuerySearchSaveDialog *) data;
...
static void
query_search_save_cancel (GtkButton * button, gpointer data)
{
  QuerySearchSaveDialog *dialog = (QuerySearchSaveDialog *) data;
...
static QuerySearchSaveDialog *
query_search_save_dialog_create (void)
{
  ...
  g_signal_connect (G_OBJECT (window), "delete_event", G_CALLBACK (query_search_save_dialog_deleted), dialog);
  g_signal_connect (G_OBJECT (window), "key_press_event", G_CALLBACK (query_search_save_dialog_key_pressed), dialog);
  MANAGE_WINDOW_SIGNALS_CONNECT (window);
  ...
  g_signal_connect (G_OBJECT (folder_btn), "clicked", G_CALLBACK (query_search_save_dialog_select_folder), dialog);
  ...
  g_signal_connect (G_OBJECT (name_entry), "activate", G_CALLBACK (query_search_save_activated), dialog);
  ...
  g_signal_connect (G_OBJECT (ok_btn), "clicked", G_CALLBACK (query_search_save_ok), dialog);
  g_signal_connect (G_OBJECT (cancel_btn), "clicked", G_CALLBACK (query_search_save_cancel), dialog);
...
static void
query_search_save_dialog_destroy (QuerySearchSaveDialog * dialog)
{
...
static FolderItem *
query_search_create_vfolder (FolderItem * parent, const gchar * name)
{
  gchar *path;
  gchar *fs_name;
  gchar *fullpath;
  ...
  fullpath = g_strconcat (path, G_DIR_SEPARATOR_S, fs_name ? fs_name : name, NULL);
  g_free (fs_name);
  g_free (path);
...
static void
query_search_vfolder_update_rule (FolderItem * item)
{
  GSList list;
  FilterRule *rule;
  gchar *file;
...
static void
query_search_save (GtkButton * button, gpointer data)
{
  QuerySearchSaveDialog *dialog;
  const gchar *id, *name;
          ...
          if (item)
            {
              ...
              folderview_append_item (folderview_get (), NULL, item, TRUE);
              folder_write_list ();
            }
        }
    }
...
static void
query_search_close (GtkButton * button, gpointer data)
{
  if (search_window.on_search)
    search_window.cancelled = TRUE;
...
static void
query_search_entry_activated (GtkWidget * widget, gpointer data)
{
  gtk_button_clicked (GTK_BUTTON (search_window.search_btn));
}

static gint
query_search_deleted (GtkWidget * widget, GdkEventAny * event, gpointer data)
{
...
static GSList *
query_search_get_selected_msg_list (void)
{
  GtkTreeModel *model = GTK_TREE_MODEL (search_window.store);
  GtkTreeSelection *selection;
  GList *list, *cur;
  ...
  selection = gtk_tree_view_get_selection (GTK_TREE_VIEW (search_window.treeview));
...
static void
query_search_open_msg (gboolean new_window)
{
  GSList *mlist;
  MsgInfo *msginfo;
  MessageView *msgview;
...
static void
query_search_reply_forward (ComposeMode mode)
{
  GSList *mlist;
  MsgInfo *msginfo;
...
static void
query_search_move_copy (gboolean is_copy)
{
  GSList *mlist, *cur;
  FolderItem *dest;
  MsgInfo *msginfo;
  ...
  if (is_copy)
    dest = foldersel_folder_sel_full (NULL, FOLDER_SEL_COPY, NULL, _("Select folder to copy"));
  else
    dest = foldersel_folder_sel_full (NULL, FOLDER_SEL_MOVE, NULL, _("Select folder to move"));
...
static void
query_search_create_filter (FilterCreateType type)
{
  GSList *mlist;
  MsgInfo *msginfo;
  gchar *header = NULL;
...
static gint
query_search_cmp_by_folder (GtkTreeModel * model, GtkTreeIter * a, GtkTreeIter * b, gpointer data)
{
  gchar *folder_a = NULL, *folder_b = NULL;
  MsgInfo *msginfo_a = NULL, *msginfo_b = NULL;
  gint ret;

  gtk_tree_model_get (model, a, COL_FOLDER, &folder_a, COL_MSGINFO, &msginfo_a, -1);
  gtk_tree_model_get (model, b, COL_FOLDER, &folder_b, COL_MSGINFO, &msginfo_b, -1);
...
static gint
query_search_cmp_by_subject (GtkTreeModel * model, GtkTreeIter * a, GtkTreeIter * b, gpointer data)
{
  MsgInfo *msginfo_a = NULL, *msginfo_b = NULL;
  gint ret;
...
static gint
query_search_cmp_by_from (GtkTreeModel * model, GtkTreeIter * a, GtkTreeIter * b, gpointer data)
{
  MsgInfo *msginfo_a = NULL, *msginfo_b = NULL;
  gint ret;
...
static gint
query_search_cmp_by_date (GtkTreeModel * model, GtkTreeIter * a, GtkTreeIter * b, gpointer data)
{
  MsgInfo *msginfo_a = NULL, *msginfo_b = NULL;
