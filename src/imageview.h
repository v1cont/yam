...
void imageview_show_image (ImageView * imageview, MimeInfo * mimeinfo, const gchar * file, gboolean resize);
void imageview_clear (ImageView * imageview);
void imageview_destroy (ImageView * imageview);

GdkPixbuf *imageview_get_resized_pixbuf (GdkPixbuf * pixbuf, GtkWidget * parent, gint margin);
