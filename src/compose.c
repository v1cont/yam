...
static GtkWidget *compose_toolbar_create_from_list (Compose * compose, GList * item_list);
static void compose_set_toolbar_button_visibility (Compose * compose);

static GtkWidget *compose_account_option_menu_create (Compose * compose, GtkWidget * hbox);
static GtkWidget *compose_signature_menu_create (Compose * compose, GtkWidget * hbox);
...
static void compose_entries_set_from_item (Compose * compose, FolderItem * item, ComposeMode mode);
...
static gchar *compose_quote_fmt (Compose * compose,
                                 MsgInfo * msginfo, const gchar * fmt, const gchar * qmark, const gchar * body);

static void compose_reply_set_entry (Compose * compose, MsgInfo * msginfo, ComposeMode mode);
static void compose_reedit_set_entry (Compose * compose, MsgInfo * msginfo);

static void compose_insert_sig (Compose * compose, gboolean append, gboolean replace, gboolean scroll);
static void compose_enable_sig (Compose * compose);
static gchar *compose_get_signature_str (Compose * compose);

static void compose_insert_file (Compose * compose, const gchar * file, gboolean scroll);
...
static gint compose_write_to_file (Compose * compose, const gchar * file, gboolean is_draft);
...
static gint compose_write_attach (Compose * compose, FILE * fp, const gchar * charset);
static gint compose_write_headers (Compose * compose, FILE * fp, const gchar * charset,
                                   const gchar * body_charset, EncodingType encoding, gboolean is_draft);
...
static void compose_convert_header (Compose * compose, gchar * dest, gint len,
                                    const gchar * src, gint header_len, gboolean addr_field, const gchar * encoding);
static gchar *compose_convert_filename (Compose * compose, const gchar * src, const gchar * param_name,
...
static gboolean toolbar_button_pressed (GtkWidget * widget, GdkEventButton * event, gpointer data);

static void account_activated (GtkComboBox * widget, gpointer data);
...
static void compose_send_later_cb (gpointer data, guint action, GtkWidget * widget);

static void compose_draft_cb (gpointer data, guint action, GtkWidget * widget);

static void compose_attach_open_cb (gpointer data, guint action, GtkWidget * widget);
static void compose_attach_cb (gpointer data, guint action, GtkWidget * widget);
static void compose_insert_file_cb (gpointer data, guint action, GtkWidget * widget);
static void compose_insert_sig_cb (gpointer data, guint action, GtkWidget * widget);

static void compose_close_cb (gpointer data, guint action, GtkWidget * widget);

static void compose_set_encoding_cb (gpointer data, guint action, GtkWidget * widget);
...
static void compose_ext_editor_cb (gpointer data, guint action, GtkWidget * widget);

static gint compose_delete_cb (GtkWidget * widget, GdkEventAny * event, gpointer data);

static gint compose_window_state_cb (GtkWidget * widget, GdkEventWindowState * event, gpointer data);
...
static void compose_toggle_autowrap_cb (gpointer data, guint action, GtkWidget * widget);

static void compose_toggle_to_cb (gpointer data, guint action, GtkWidget * widget);
static void compose_toggle_cc_cb (gpointer data, guint action, GtkWidget * widget);
static void compose_toggle_bcc_cb (gpointer data, guint action, GtkWidget * widget);
static void compose_toggle_replyto_cb (gpointer data, guint action, GtkWidget * widget);
static void compose_toggle_followupto_cb (gpointer data, guint action, GtkWidget * widget);
static void compose_toggle_attach_cb (gpointer data, guint action, GtkWidget * widget);
static void compose_customize_toolbar_cb (gpointer data, guint action, GtkWidget * widget);

static void compose_toggle_mdn_cb (gpointer data, guint action, GtkWidget * widget);

#if USE_GPGME
static void compose_toggle_sign_cb (gpointer data, guint action, GtkWidget * widget);
static void compose_toggle_encrypt_cb (gpointer data, guint action, GtkWidget * widget);
#endif
...
static void compose_toggle_spell_cb (gpointer data, guint action, GtkWidget * widget);
static void compose_set_spell_lang_cb (GtkWidget * widget, gpointer data);
#endif

static void compose_attach_drag_received_cb (GtkWidget * widget, GdkDragContext * drag_context, gint x, gint y,
                                             GtkSelectionData * data, guint info, guint time, gpointer user_data);
static void compose_insert_drag_received_cb (GtkWidget * widget, GdkDragContext * drag_context, gint x, gint y,
                                             GtkSelectionData * data, guint info, guint time, gpointer user_data);
...
static GtkItemFactoryEntry compose_entries[] = {
  ...
  {N_("/_File/_Send"), "<shift><control>E", compose_send_cb, 0, NULL},
  {N_("/_File/Send _later"), "<shift><control>S", compose_send_later_cb, 0, NULL},
  {N_("/_File/---"), NULL, NULL, 0, "<Separator>"},
  {N_("/_File/Save to _draft folder"), "<shift><control>D", compose_draft_cb, 0, NULL},
  {N_("/_File/Save and _keep editing"), "<control>S", compose_draft_cb, 1, NULL},
  {N_("/_File/---"), NULL, NULL, 0, "<Separator>"},
  ...
  {N_("/_Edit/Paste as _quotation"), NULL, compose_paste_as_quote_cb, 0, NULL},
  {N_("/_Edit/Select _all"), "<control>A", compose_allsel_cb, 0, NULL},
  {N_("/_Edit/---"), NULL, NULL, 0, "<Separator>"},
  {N_("/_Edit/_Wrap current paragraph"), "<control>L", compose_wrap_cb, 0, NULL},
  {N_("/_Edit/Wrap all long _lines"), "<control><alt>L", compose_wrap_cb, 1, NULL},
  ...
  {N_("/_View/---"), NULL, NULL, 0, "<Separator>"},
  {N_("/_View/Cu_stomize toolbar..."), NULL, compose_customize_toolbar_cb, 0, NULL},
  {N_("/_View/---"), NULL, NULL, 0, "<Separator>"},
...
#define ENC_ACTION(action) \
  ...
  {N_("/_View/Character _encoding/_Automatic"), NULL, compose_set_encoding_cb, C_AUTO, "<RadioItem>"},
  {N_("/_View/Character _encoding/---"), NULL, NULL, 0, "<Separator>"},

  {N_("/_View/Character _encoding/7bit ascii (US-ASC_II)"), ENC_ACTION (C_US_ASCII)},
  {N_("/_View/Character _encoding/Unicode (_UTF-8)"), ENC_ACTION (C_UTF_8)},
  {N_("/_View/Character _encoding/---"), NULL, NULL, 0, "<Separator>"},

  {N_("/_View/Character _encoding/Western European (ISO-8859-_1)"), ENC_ACTION (C_ISO_8859_1)},
  {N_("/_View/Character _encoding/Western European (ISO-8859-15)"), ENC_ACTION (C_ISO_8859_15)},
  {N_("/_View/Character _encoding/---"), NULL, NULL, 0, "<Separator>"},

  {N_("/_View/Character _encoding/Central European (ISO-8859-_2)"), ENC_ACTION (C_ISO_8859_2)},
  {N_("/_View/Character _encoding/---"), NULL, NULL, 0, "<Separator>"},

  {N_("/_View/Character _encoding/_Baltic (ISO-8859-13)"), ENC_ACTION (C_ISO_8859_13)},
  {N_("/_View/Character _encoding/Baltic (ISO-8859-_4)"), ENC_ACTION (C_ISO_8859_4)},
  {N_("/_View/Character _encoding/Baltic (Windows-1257)"), ENC_ACTION (C_WINDOWS_1257)},
  {N_("/_View/Character _encoding/---"), NULL, NULL, 0, "<Separator>"},

  {N_("/_View/Character _encoding/Greek (ISO-8859-_7)"), ENC_ACTION (C_ISO_8859_7)},
  {N_("/_View/Character _encoding/---"), NULL, NULL, 0, "<Separator>"},

  {N_("/_View/Character _encoding/Arabic (ISO-8859-_6)"), ENC_ACTION (C_ISO_8859_6)},
  {N_("/_View/Character _encoding/Arabic (Windows-1256)"), ENC_ACTION (C_WINDOWS_1256)},
  {N_("/_View/Character _encoding/---"), NULL, NULL, 0, "<Separator>"},

  {N_("/_View/Character _encoding/Hebrew (ISO-8859-_8)"), ENC_ACTION (C_ISO_8859_8)},
  {N_("/_View/Character _encoding/Hebrew (Windows-1255)"), ENC_ACTION (C_WINDOWS_1255)},
  {N_("/_View/Character _encoding/---"), NULL, NULL, 0, "<Separator>"},

  {N_("/_View/Character _encoding/Turkish (ISO-8859-_9)"), ENC_ACTION (C_ISO_8859_9)},
  {N_("/_View/Character _encoding/---"), NULL, NULL, 0, "<Separator>"},

  {N_("/_View/Character _encoding/Cyrillic (ISO-8859-_5)"), ENC_ACTION (C_ISO_8859_5)},
  {N_("/_View/Character _encoding/Cyrillic (KOI8-_R)"), ENC_ACTION (C_KOI8_R)},
  {N_("/_View/Character _encoding/Cyrillic (KOI8-U)"), ENC_ACTION (C_KOI8_U)},
  {N_("/_View/Character _encoding/Cyrillic (Windows-1251)"), ENC_ACTION (C_WINDOWS_1251)},
  {N_("/_View/Character _encoding/---"), NULL, NULL, 0, "<Separator>"},

  {N_("/_View/Character _encoding/Japanese (ISO-2022-_JP)"), ENC_ACTION (C_ISO_2022_JP)},
  {N_("/_View/Character _encoding/---"), NULL, NULL, 0, "<Separator>"},

  {N_("/_View/Character _encoding/Simplified Chinese (_GB2312)"), ENC_ACTION (C_GB2312)},
  {N_("/_View/Character _encoding/Simplified Chinese (GBK)"), ENC_ACTION (C_GBK)},
  {N_("/_View/Character _encoding/Traditional Chinese (_Big5)"), ENC_ACTION (C_BIG5)},
  {N_("/_View/Character _encoding/---"), NULL, NULL, 0, "<Separator>"},

  {N_("/_View/Character _encoding/Korean (EUC-_KR)"), ENC_ACTION (C_EUC_KR)},
  {N_("/_View/Character _encoding/---"), NULL, NULL, 0, "<Separator>"},

  {N_("/_View/Character _encoding/Thai (TIS-620)"), ENC_ACTION (C_TIS_620)},
  {N_("/_View/Character _encoding/Thai (Windows-874)"), ENC_ACTION (C_WINDOWS_874)},
  ...
  {N_("/_Tools/Edit with e_xternal editor"), "<shift><control>X", compose_ext_editor_cb, 0, NULL},
  {N_("/_Tools/---"), NULL, NULL, 0, "<Separator>"},
...
Compose *
compose_new (PrefsAccount * account, FolderItem * item, const gchar * mailto, GPtrArray * attach_files)
{
  Compose *compose;
  GtkTextView *text;
  ...
  if (account->protocol != A_NNTP)
    {
      if (mailto && *mailto != '\0')
        ...
        {
          compose_entries_set_from_item (compose, item, COMPOSE_NEW);
          if (item->auto_to)
            gtk_widget_grab_focus (compose->subject_entry);
          else
  ...
  else
    {
      if (mailto && *mailto != '\0')
        {
          compose_entry_append (compose, mailto, COMPOSE_ENTRY_NEWSGROUPS);
          gtk_widget_grab_focus (compose->subject_entry);
        }
      else
  ...
  yam_plugin_signal_emit ("compose-created", compose);

  if (prefs_common.enable_autosave && prefs_common.autosave_itv > 0)
    compose->autosave_tag =
      g_timeout_add_full (G_PRIORITY_LOW, prefs_common.autosave_itv * 60 * 1000, autosave_timeout, compose, NULL);
...
Compose *
compose_reply (MsgInfo * msginfo, FolderItem * item, ComposeMode mode, const gchar * body)
{
  Compose *compose;
  ...
  if (msginfo->folder)
    {
      ...
      if (id)
        {
          compose->reply_target = g_strdup_printf ("%s/%u", id, msginfo->msgnum);
          g_free (id);
        }
    }
  ...
  if (quote)
    compose_quote_fmt (compose, replyinfo, prefs_common.quotefmt, prefs_common.quotemark, body);
...
#if USE_GPGME
  if (rfc2015_is_available () && account->encrypt_reply && MSG_IS_ENCRYPTED (replyinfo->flags))
    {
...
Compose *
compose_forward (GSList * mlist, FolderItem * item, gboolean as_attach, const gchar * body)
{
  Compose *compose;
  PrefsAccount *account = NULL;
  GtkTextView *text;
          ...
          if (id)
            {
              ...
              g_string_append_printf (forward_targets, "%s/%u", id, msginfo->msgnum);
              g_free (id);
            }
        }
    }
  if (forward_targets->len > 0)
    compose->forward_targets = g_string_free (forward_targets, FALSE);
  else
  ...
  if (mlist->next == NULL && msginfo->subject && *msginfo->subject)
    compose_entry_append (compose, msginfo->subject, COMPOSE_ENTRY_SUBJECT);
  if (item)
      ...
      if (as_attach)
        {
          ...
          if (!is_file_exist (msgfile))
            ...
            compose_attach_append (compose, msgfile, msgfile, "message/rfc822");
      ...
      else
        {
          ...
          compose_quote_fmt (compose, full_msginfo, prefs_common.fw_quotefmt, prefs_common.fw_quotemark, body);
...
Compose *
compose_redirect (MsgInfo * msginfo, FolderItem * item)
{
  Compose *compose;
...
Compose *
compose_reedit (MsgInfo * msginfo)
{
  Compose *compose;
  PrefsAccount *account;
  GtkTextView *text;
  ...
  if (msginfo->folder->stype == F_DRAFT || msginfo->folder->stype == F_QUEUE)
    {
      compose = compose_find_window_by_target (msginfo);
      if (compose)
        {
          debug_print ("compose_reedit(): existing window found.\n");
...
static void
compose_entry_show (Compose * compose, ComposeEntryType type)
{
  GtkItemFactory *ifactory;
...
static GtkEntry *
compose_get_entry (Compose * compose, ComposeEntryType type)
{
  GtkEntry *entry;
...
void
compose_entry_set (Compose * compose, const gchar * text, ComposeEntryType type)
{
  GtkEntry *entry;
...
void
compose_entry_append (Compose * compose, const gchar * text, ComposeEntryType type)
{
  GtkEntry *entry;
  const gchar *str;
  gint pos;
...
gchar *
compose_entry_get_text (Compose * compose, ComposeEntryType type)
{
  GtkEntry *entry;
...
static void
compose_entries_set (Compose * compose, const gchar * mailto)
{
  gchar *to = NULL;
  gchar *cc = NULL;
  gchar *subject = NULL;
...
static void
compose_entries_set_from_item (Compose * compose, FolderItem * item, ComposeMode mode)
{
  ...
  if (item->auto_to)
    {
      if (mode != COMPOSE_REPLY || item->use_auto_to_on_reply)
        compose_entry_set (compose, item->auto_to, COMPOSE_ENTRY_TO);
    }
  if (item->auto_cc)
  ...
  if (item->auto_replyto)
    compose_entry_set (compose, item->auto_replyto, COMPOSE_ENTRY_REPLY_TO);
}

#undef ACTIVATE_MENU

static gint
compose_parse_header (Compose * compose, MsgInfo * msginfo)
{
  ...
  if (hentry[H_CONTENT_TYPE].body != NULL)
    {
      procmime_scan_content_type_str (hentry[H_CONTENT_TYPE].body, NULL, &charset, NULL, NULL);
  ...
  if (hentry[H_REPLY_TO].body != NULL)
    {
      if (hentry[H_REPLY_TO].body[0] != '\0')
        compose->replyto = conv_unmime_header (hentry[H_REPLY_TO].body, charset);
  ...
  if (hentry[H_BCC].body != NULL)
    {
      if (compose->mode == COMPOSE_REEDIT)
        compose->bcc = conv_unmime_header (hentry[H_BCC].body, charset);
  ...
  if (hentry[H_FOLLOWUP_TO].body != NULL)
    {
      if (hentry[H_FOLLOWUP_TO].body[0] != '\0')
        compose->followup_to = conv_unmime_header (hentry[H_FOLLOWUP_TO].body, charset);
  ...
  if (hentry[H_LIST_POST].body != NULL)
    {
      ...
      if (hentry[H_LIST_POST].body[0] != '\0')
        {
          scan_mailto_url (hentry[H_LIST_POST].body, &to, NULL, NULL, NULL, NULL, NULL);
          if (to)
            {
...
static gchar *
compose_parse_references (const gchar * ref, const gchar * msgid)
{
...
static gint
compose_parse_source_msg (Compose * compose, MsgInfo * msginfo)
{
  static HeaderEntry hentry[] = { {"X-YAM-Reply:", NULL, FALSE},
  {"X-YAM-Forward:", NULL, FALSE},
  {"REP:", NULL, FALSE},
  {"FWD:", NULL, FALSE},
  {"Disposition-Notification-To:", NULL, FALSE},
  {"X-YAM-Compose-AutoWrap:", NULL, FALSE},
  {"X-YAM-Compose-CheckSpell:", NULL, FALSE},
  {"X-YAM-Compose-SpellLang:", NULL, FALSE},
  {"X-YAM-Compose-UseSigning:", NULL, FALSE},
  {"X-YAM-Compose-UseEncryption:", NULL, FALSE},
  {NULL, NULL, FALSE}
  };
  ...
  enum {
    ...
    H_FWD = 3,
    H_MDN = 4,
    H_X_YAM_COMPOSE_AUTOWRAP = 5,
    H_X_YAM_COMPOSE_CHECKSPELL = 6,
    H_X_YAM_COMPOSE_SPELLLANG = 7,
    H_X_YAM_COMPOSE_USESIGNING = 8,
    H_X_YAM_COMPOSE_USEENCRYPTION = 9
  };
  ...
  while ((hnum = procheader_get_one_field (buf, sizeof (buf), fp, hentry)) != -1)
    {
      ...
      while (g_ascii_isspace (*str))
        ++str;
      if ((hnum == H_X_YAM_REPLY || hnum == H_REP) && !compose->reply_target)
        compose->reply_target = g_strdup (str);
      else if ((hnum == H_X_YAM_FORWARD || hnum == H_FWD) && !compose->forward_targets)
        compose->forward_targets = g_strdup (str);
      else if (hnum == H_MDN)
        compose->use_mdn = TRUE;
      else if (hnum == H_X_YAM_COMPOSE_AUTOWRAP)
        {
...
#if USE_GSPELL
      else if (hnum == H_X_YAM_COMPOSE_CHECKSPELL)
        {
          if (g_ascii_strcasecmp (str, "TRUE") == 0)
      ...
      else if (hnum == H_X_YAM_COMPOSE_SPELLLANG)
        {
...
#endif
#if USE_GPGME
      else if (hnum == H_X_YAM_COMPOSE_USESIGNING)
        {
          if (g_ascii_strcasecmp (str, "TRUE") == 0)
      ...
      else if (hnum == H_X_YAM_COMPOSE_USEENCRYPTION)
        {
          if (g_ascii_strcasecmp (str, "TRUE") == 0)
...
static gchar *
compose_quote_fmt (Compose * compose, MsgInfo * msginfo, const gchar * fmt, const gchar * qmark, const gchar * body)
{
  GtkTextView *text = GTK_TEXT_VIEW (compose->text);
  GtkTextBuffer *buffer;
  GtkTextMark *mark;
...
static void
compose_reply_set_entry (Compose * compose, MsgInfo * msginfo, ComposeMode mode)
{
  GSList *cc_list = NULL;
  GSList *cur;
  GHashTable *to_table;
  gboolean to_all = FALSE, to_ml = FALSE, ignore_replyto = FALSE;
  gchar *from_str = NULL, *to_str = NULL, *cc_str = NULL, *replyto_str = NULL;
      ...
      if (to_ml && compose->ml_post)
        {
          ...
          if ((!to_str ||
               !strcasestr_with_skip_quote (to_str,
                                            compose->ml_post)) &&
              (!cc_str || !strcasestr_with_skip_quote (cc_str, compose->ml_post)))
            to_ml = FALSE;
        }
      if (to_ml && compose->ml_post)
        {
          compose_entry_set (compose, compose->ml_post, COMPOSE_ENTRY_TO);
          if (replyto_str && !address_equal (replyto_str, compose->ml_post))
            compose_entry_set (compose, replyto_str, COMPOSE_ENTRY_CC);
        }
      else if (prefs_common.inherit_recipient_on_self_reply && address_equal (compose->account->address, from_str))
        {
          compose_entry_set (compose, to_str, COMPOSE_ENTRY_TO);
          if (to_all)
            {
              compose_entry_set (compose, cc_str, COMPOSE_ENTRY_CC);
              to_all = FALSE;
            }
        }
      else
        {
          compose_entry_set (compose, (replyto_str && !ignore_replyto)
                             ? replyto_str : from_str ? from_str : "", COMPOSE_ENTRY_TO);
        }
    }
  else
    {
      if (ignore_replyto)
        compose_entry_set (compose, from_str ? from_str : "", COMPOSE_ENTRY_TO);
      else
        {
          if (to_all)
            {
              compose_entry_set
                (compose, (replyto_str && !ignore_replyto) ? replyto_str : from_str ? from_str : "", COMPOSE_ENTRY_TO);
            }
          compose_entry_set (compose, compose->followup_to ? compose->followup_to
                             : compose->newsgroups ? compose->newsgroups : "", COMPOSE_ENTRY_NEWSGROUPS);
        }
    }
  ...
  if (compose->account->address)
    g_hash_table_insert (to_table, g_strdup (compose->account->address), GINT_TO_POINTER (1));
  ...
  if (cc_list)
    {
      for (cur = cc_list; cur != NULL; cur = cur->next)
        compose_entry_append (compose, (gchar *) cur->data, COMPOSE_ENTRY_CC);
...
static void
compose_reedit_set_entry (Compose * compose, MsgInfo * msginfo)
{
  g_return_if_fail (msginfo != NULL);
  g_return_if_fail (compose->account != NULL);
  ...
  if (compose->account->protocol == A_NNTP)
    {
      compose_entry_set (compose, compose->newsgroups, COMPOSE_ENTRY_NEWSGROUPS);
      compose_entry_set (compose, compose->followup_to, COMPOSE_ENTRY_FOLLOWUP_TO);
    }
  compose_entry_set (compose, msginfo->subject, COMPOSE_ENTRY_SUBJECT);
}

static void
compose_insert_sig (Compose * compose, gboolean append, gboolean replace, gboolean scroll)
{
  GtkTextView *text = GTK_TEXT_VIEW (compose->text);
  GtkTextBuffer *buffer;
  GtkTextMark *mark;
  ...
  if (replace)
    {
      ...
      while (gtk_text_iter_starts_tag (&start_iter, compose->sig_tag) ||
             gtk_text_iter_forward_to_tag_toggle (&start_iter, compose->sig_tag))
        {
          end_iter = start_iter;
          if (gtk_text_iter_forward_to_tag_toggle (&end_iter, compose->sig_tag))
            {
  ...
  if (sig_str)
    {
      if (!replace)
        ...
        gtk_text_buffer_insert (buffer, &iter, "\n", 1);
      gtk_text_buffer_insert_with_tags (buffer, &iter, sig_str, -1, compose->sig_tag, NULL);
      g_free (sig_str);
      if (scroll)
        gtk_text_buffer_place_cursor (buffer, &iter);
    }
...
static void
compose_enable_sig (Compose * compose)
{
  GtkTextView *text = GTK_TEXT_VIEW (compose->text);
  GtkTextBuffer *buffer;
  ...
  if (yam_text_buffer_find (buffer, &iter, sig_str, TRUE, &start))
    {
      end = start;
      gtk_text_iter_forward_chars (&end, g_utf8_strlen (sig_str, -1));
      gtk_text_buffer_apply_tag (buffer, compose->sig_tag, &start, &end);
    }
...
static gchar *
compose_get_signature_str (Compose * compose)
{
  gchar *sig_path;
  gchar *sig_body = NULL;
  ...
  if (g_path_is_absolute (compose->account->sig_path) || compose->account->sig_type == SIG_COMMAND)
    sig_path = g_strdup (compose->account->sig_path);
  else
    sig_path = g_strconcat (g_get_home_dir (), G_DIR_SEPARATOR_S, compose->account->sig_path, NULL);
  ...
  if (sig_body)
    {
      ...
      utf8_sig_body = conv_codeset_strdup_full (sig_body, conv_get_locale_charset_str (), CS_INTERNAL, &error);
...
static void
compose_insert_file (Compose * compose, const gchar * file, gboolean scroll)
{
  GtkTextView *text = GTK_TEXT_VIEW (compose->text);
  GtkTextBuffer *buffer;
  GtkTextMark *mark;
  ...
  while (fgets (buf, sizeof (buf), fp) != NULL)
    {
      ...
      if (enc == C_UTF_8)
        ...
        {
          str = conv_codeset_strdup_full (buf, cur_encoding, CS_INTERNAL, &error);
          if (!str || error != 0)
            {
...
void
compose_attach_append (Compose * compose, const gchar * file, const gchar * filename, const gchar * content_type)
{
  GtkTreeIter iter;
  AttachInfo *ainfo;
  FILE *fp;
  ...
  gtk_list_store_set (compose->attach_store, &iter, COL_MIMETYPE, ainfo->content_type,
                      COL_SIZE, to_human_readable (ainfo->size), COL_NAME, ainfo->name, COL_ATTACH_INFO, ainfo, -1);

  yam_plugin_signal_emit ("compose-attach-changed", compose);
}

static void
compose_attach_parts (Compose * compose, MsgInfo * msginfo)
{
  MimeInfo *mimeinfo;
  MimeInfo *child;
  gchar *infile;
  ...
  while (child != NULL)
    {
      if (child->children || child->mime_type == MIME_MULTIPART)
        goto next;
      if (child->mime_type != MIME_MESSAGE_RFC822 && child->mime_type != MIME_IMAGE &&
          child->mime_type != MIME_AUDIO && child->mime_type != MIME_VIDEO && !child->filename && !child->name)
        goto next;
      ...
      compose_attach_append (compose, outfile, child->filename ? child->filename : child->name, child->content_type);
...
static gchar *
compose_get_quote_str (GtkTextBuffer * buffer, const GtkTextIter * start, gint * len)
{
...
static gboolean
compose_is_itemized (GtkTextBuffer * buffer, const GtkTextIter * start)
{
  GtkTextIter iter = *start;
  gunichar wc;
  gchar ch[6];
...
static gboolean
compose_get_line_break_pos (GtkTextBuffer * buffer,
                            const GtkTextIter * start, GtkTextIter * break_pos, gint max_col, gint quote_len)
{
...
static gboolean
compose_join_next_line (GtkTextBuffer * buffer, GtkTextIter * iter, const gchar * quote_str)
{
  ...
  if ((quote_str || next_quote_str) && strcmp2 (quote_str, next_quote_str) != 0)
    {
...
static void
compose_wrap_paragraph (Compose * compose, GtkTextIter * par_iter)
{
  GtkTextView *text = GTK_TEXT_VIEW (compose->text);
  GtkTextBuffer *buffer;
  ...
  while (!gtk_text_iter_ends_line (&iter))
    {
      ...
      if (compose_get_line_break_pos (buffer, &iter, &break_pos, prefs_common.linewrap_len, quote_len))
        {
...
static void
compose_wrap_all (Compose * compose)
{
  compose_wrap_all_full (compose, FALSE);
}

static void
compose_wrap_all_full (Compose * compose, gboolean autowrap)
{
  GtkTextView *text = GTK_TEXT_VIEW (compose->text);
  GtkTextBuffer *buffer;
  GtkTextIter iter;
...
static void
compose_set_title (Compose * compose)
{
  gchar *str;
  gchar *edited;
  const gchar *subject;
...
static void
compose_select_account (Compose * compose, PrefsAccount * account, gboolean init)
{
  GtkItemFactory *ifactory;
  ...
  if (account->protocol == A_NNTP && (init || prev_account->protocol != A_NNTP))
    {
  ...
  else if (account->protocol != A_NNTP && (init || prev_account->protocol == A_NNTP))
    {
  ...
  if (account->set_autocc)
    {
      ...
      if (account->auto_cc && compose->mode != COMPOSE_REEDIT)
        compose_entry_set (compose, account->auto_cc, COMPOSE_ENTRY_CC);
    }
  if (account->set_autobcc)
    {
      compose_entry_show (compose, COMPOSE_ENTRY_BCC);
      if (account->auto_bcc && compose->mode != COMPOSE_REEDIT)
        compose_entry_set (compose, account->auto_bcc, COMPOSE_ENTRY_BCC);
    }
  if (account->set_autoreplyto)
    {
      ...
      if (account->auto_replyto && compose->mode != COMPOSE_REEDIT)
        compose_entry_set (compose, account->auto_replyto, COMPOSE_ENTRY_REPLY_TO);
    }
...
static void
compose_update_signature_menu (Compose * compose)
{
  GtkTreeModel *model;
  GtkListStore *store;
  GtkTreeIter iter;
  ...
  for (i = 0; valid && i < sizeof (compose->account->sig_names) / sizeof (compose->account->sig_names[0]); i++)
    {
      if (compose->account->sig_names[i] && compose->account->sig_names[i][0] != '\0')
        name = g_strdup_printf ("%s", compose->account->sig_names[i]);
      else
  ...
  g_signal_handlers_block_by_func (G_OBJECT (compose->sig_combo), G_CALLBACK (sig_combo_changed), compose);
  gtk_combo_box_set_active (GTK_COMBO_BOX (compose->sig_combo), 0);
  g_signal_handlers_unblock_by_func (G_OBJECT (compose->sig_combo), G_CALLBACK (sig_combo_changed), compose);
...
static gboolean
compose_check_for_valid_recipient (Compose * compose)
{
  ...
  if (compose->use_newsgroups)
    newsgroups_raw = gtk_entry_get_text (GTK_ENTRY (compose->newsgroups_entry));

  if (*to_raw == '\0' && *cc_raw == '\0' && *bcc_raw == '\0' && *newsgroups_raw == '\0')
    return FALSE;
...
static gboolean
compose_check_entries (Compose * compose)
{
  const gchar *str;
  ...
  if (*str == '\0')
    {
      ...
      aval = alertpanel (_("Empty subject"), _("Subject is empty. Send it anyway?"), "yam-yes", "yam-no", NULL);
...
static gboolean
compose_check_attachments (Compose * compose)
{
  GtkTextView *text = GTK_TEXT_VIEW (compose->text);
  GtkTextBuffer *buffer;
  ...
  if (compose->use_attach && gtk_tree_model_iter_n_children (GTK_TREE_MODEL (compose->attach_store), NULL) > 0)
    return TRUE;
  ...
  while (valid)
    {
      ...
      line = gtk_text_buffer_get_text (buffer, &iter, &line_end, FALSE);
      iter = line_end;
  ...
  if (attach_found)
    {
      ...
      aval = alertpanel (_("Attachment is missing"),
                         _("There is no attachment. Send it without attachments?"), "yam-yes", "yam-no", NULL);
      if (aval != G_ALERTDEFAULT)
        return FALSE;
    }
...
static gint
check_recp_delete_event (GtkWidget * widget, GdkEventAny * event, gint * state)
{
...
static gboolean
check_recp_key_pressed (GtkWidget * widget, GdkEventKey * event, gint * state)
{
...
static void
check_recp_ok (GtkWidget * widget, gint * state)
{
  *state = GTK_RESPONSE_OK;
}

static void
check_recp_cancel (GtkWidget * widget, gint * state)
{
  *state = GTK_RESPONSE_CANCEL;
}

static gboolean
compose_check_recipients (Compose * compose)
{
  GtkWidget *window;
  GtkWidget *vbox;
  GtkWidget *hbox;
  ...
  g_signal_connect (G_OBJECT (window), "delete_event", G_CALLBACK (check_recp_delete_event), &state);
  g_signal_connect (G_OBJECT (window), "key_press_event", G_CALLBACK (check_recp_key_pressed), &state);
  ...
  label = yam_label_title (_("Check recipients"));
  gtk_box_pack_start (GTK_BOX (vbox2), label, TRUE, TRUE, 0);
  gtk_label_set_xalign (GTK_LABEL (label), 0.0);
  gtk_label_set_yalign (GTK_LABEL (label), 0.0);
  gtk_label_set_line_wrap (GTK_LABEL (label), TRUE);

  label = gtk_label_new (_("Really send this mail to the following addresses?"));
  gtk_box_pack_start (GTK_BOX (vbox2), label, TRUE, TRUE, 0);
  gtk_label_set_xalign (GTK_LABEL (label), 0.0);
  gtk_label_set_yalign (GTK_LABEL (label), 0.0);
  gtk_label_set_line_wrap (GTK_LABEL (label), TRUE);
  ...
  if (compose->account->name && *compose->account->name)
    {
      g_snprintf (buf, sizeof (buf), "%s <%s>", compose->account->name, compose->account->address);
  ...
  hbox = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 0);
  label = gtk_label_new (prefs_common.trans_hdr ? _("Subject:") : "Subject:");
  gtk_box_pack_end (GTK_BOX (hbox), label, FALSE, FALSE, 0);
      ...
      if (to_list)
        {
          ...
          gtk_tree_store_set (store, &parent, 0, prefs_common.trans_hdr ? _("To:") : "To:", -1);
          for (cur = to_list; cur != NULL; cur = cur->next)
            {
              gtk_tree_store_append (store, &iter, &parent);
              gtk_tree_store_set (store, &iter, 0, (gchar *) cur->data, -1);
            }
          slist_free_strings (to_list);
          g_slist_free (to_list);
        }
  ...
  if (compose->use_cc)
    {
      ...
      if (to_list)
        {
          gtk_tree_store_append (store, &parent, NULL);
          gtk_tree_store_set (store, &parent, 0, prefs_common.trans_hdr ? _("Cc:") : "Cc:", -1);
          for (cur = to_list; cur != NULL; cur = cur->next)
            {
              gtk_tree_store_append (store, &iter, &parent);
              gtk_tree_store_set (store, &iter, 0, (gchar *) cur->data, -1);
  ...
  if (compose->use_bcc)
    {
      ...
      if (to_list)
        {
          gtk_tree_store_append (store, &parent, NULL);
          gtk_tree_store_set (store, &parent, 0, prefs_common.trans_hdr ? _("Bcc:") : "Bcc:", -1);
          for (cur = to_list; cur != NULL; cur = cur->next)
            {
              gtk_tree_store_append (store, &iter, &parent);
              gtk_tree_store_set (store, &iter, 0, (gchar *) cur->data, -1);
  ...
  column = gtk_tree_view_column_new_with_attributes (_("Address"), renderer, "text", 0, NULL);
  gtk_tree_view_append_column (GTK_TREE_VIEW (treeview), column);

  gtk_tree_view_expand_all (GTK_TREE_VIEW (treeview));

  yam_stock_button_set_create (&hbbox, &ok_btn, _("_Send"), &cancel_btn, "yam-cancel", NULL, NULL);
  gtk_box_pack_end (GTK_BOX (vbox), hbbox, FALSE, FALSE, 0);
  gtk_widget_grab_default (ok_btn);
  gtk_widget_grab_focus (ok_btn);

  g_signal_connect (G_OBJECT (ok_btn), "clicked", G_CALLBACK (check_recp_ok), &state);
  g_signal_connect (G_OBJECT (cancel_btn), "clicked", G_CALLBACK (check_recp_cancel), &state);
...
static gboolean
compose_check_activities (Compose * compose)
{
  if (inc_is_active ())
    {
...
static void
compose_add_new_recipients_to_addressbook (Compose * compose)
{
...
void
compose_lock (Compose * compose)
{
  compose->lock_count++;
}

void
compose_unlock (Compose * compose)
{
...
void
compose_block_modified (Compose * compose)
{
  compose->block_modified = TRUE;
}

void
compose_unblock_modified (Compose * compose)
{
...
static gint
compose_send_real (Compose * compose)
{
  ...
  g_snprintf (tmp, sizeof (tmp), "%s%ctmpmsg.%p", get_tmp_dir (), G_DIR_SEPARATOR, compose);
  ...
  yam_plugin_signal_emit ("compose-send", compose, compose->mode, 0, tmp, compose->to_list, &cancel);
  if (cancel)
    {
      g_unlink (tmp);
      C_UNLOCK ();
  ...
  if (ok == 0 && compose->newsgroup_list)
    {
      ...
      if (ok < 0)
        {
          alertpanel_error (_("Error occurred while posting the message to %s ."), compose->account->nntp_server);
          g_unlink (tmp);
          C_UNLOCK ();
          return -1;
        }
      ...
      if (compose->mode == COMPOSE_REEDIT)
        {
          ...
          if (compose->targetinfo)
            folderview_update_item (compose->targetinfo->folder, TRUE);
        }

      if (compose->reply_target)
        send_message_set_reply_flag (compose->reply_target, compose->inreplyto);
      else if (compose->forward_targets)
        send_message_set_forward_flags (compose->forward_targets);
      ...
      if (prefs_common.savemsg)
        {
          ...
          if (!drop_done)
            {
              outbox = account_get_special_folder (compose->account, F_OUTBOX);
...
#if USE_GPGME
static const gchar *
compose_get_self_key_id (Compose * compose)
{
...
static gint
compose_create_signers_list (Compose * compose, GSList ** pkey_list)
{
  const gchar *key_id = NULL;
  GSList *key_list;
  ...
  if (!key_list)
    {
      alertpanel_error (_("Could not find any key associated with " "currently selected key id `%s'."), key_id);
      return -1;
    }
...
static GSList *
compose_create_encrypt_recipients_list (Compose * compose)
{
...
static gint
compose_clearsign_text (Compose * compose, gchar ** text)
{
  GSList *key_list;
  gchar *tmp_file;
...
static gint
compose_encrypt_armored (Compose * compose, gchar ** text)
{
  gchar *tmp_file;
  GSList *recp_list;
...
static gint
compose_encrypt_sign_armored (Compose * compose, gchar ** text)
{
  GSList *key_list;
  GSList *recp_list;
  gchar *tmp_file;
...
static gint
compose_write_to_file (Compose * compose, const gchar * file, gboolean is_draft)
{
  GtkTextBuffer *buffer;
  ...
  if (is_ascii_str (chars))
  ...
  else
    {
      ...
      buf = conv_codeset_strdup_full (chars, src_charset, body_charset, &error);
      if (!buf || error != 0)
        {
          ...
          if (!is_draft)
            {
              msg = g_strdup_printf (_("Can't convert the character encoding of the message body from %s to %s.\n"
                                       "\n" "Send it as %s anyway?"), src_charset, body_charset, src_charset);
              aval = alertpanel_full
                (_("Code conversion error"), msg, ALERT_ERROR, G_ALERTALTERNATE, FALSE, "yam-yes", "yam-no", NULL);
              g_free (msg);
            }
      ...
      if (prefs_common.encoding_method == CTE_BASE64)
        ...
        encoding = procmime_get_encoding_for_charset (body_charset);
    }
  g_free (chars);
  ...
  if (rfc2015_is_available () && !is_draft)
    {
      if ((compose->use_encryption &&
           compose->account->ascii_armored) || (compose->use_signing && compose->account->clearsign))
        {
  ...
  debug_print ("src encoding = %s, out encoding = %s, "
               ...
               src_charset, out_charset, body_charset, procmime_get_encoding_str (encoding));

  /* check for line length limit */
  if (!is_draft &&
      encoding != ENC_QUOTED_PRINTABLE && encoding != ENC_BASE64 && check_line_length (buf, 1000, &line) < 0)
    {
      AlertValue aval;
      gchar *msg;
      ...
      aval = alertpanel_full (_("Line length limit"),
                              msg, ALERT_WARNING, G_ALERTALTERNATE, FALSE, "yam-yes", "yam-no", NULL);
      if (aval != G_ALERTDEFAULT)
        {
          g_free (msg);
          fclose (fp);
  ...
  /* write headers */
  if (compose_write_headers (compose, fp, out_charset, body_charset, encoding, is_draft) < 0)
    {
  ...
  if (compose->use_attach && gtk_tree_model_iter_n_children (model, NULL) > 0)
    {
#if USE_GPGME
      ...
      if (!rfc2015_is_available () || (!compose->use_signing && !compose->use_encryption))
#endif
                  ...
                  aval = alertpanel_full
                    (_("Encrypting with Bcc"),
                     _("This message has Bcc recipients. If this message is encrypted, all Bcc recipients will be visible by examing the encryption key list, leading to loss of confidentiality.\n"
                      "\n" "Send it anyway?"), ALERT_WARNING, G_ALERTDEFAULT, FALSE, "yam-yes", "yam-no", NULL);
                  if (aval != G_ALERTDEFAULT)
                    {
                      g_free (bcc);
                      g_unlink (file);
...
static gint
compose_write_body_to_file (Compose * compose, const gchar * file)
{
  GtkTextBuffer *buffer;
  GtkTextIter start, end;
  FILE *fp;
...
static gint
compose_redirect_write_to_file (Compose * compose, const gchar * file)
{
  FILE *fp;
  FILE *fdest;
  size_t len;
  ...
  while (procheader_get_one_field (buf, sizeof (buf), fp, NULL) == 0)
    {
      if (g_ascii_strncasecmp (buf, "Return-Path:",
          ...
          g_ascii_strncasecmp (buf, "Subject:",
                               strlen ("Subject:")) == 0 ||
          g_ascii_strncasecmp (buf, "X-UIDL:", strlen ("X-UIDL:")) == 0)
        continue;
...
static gint
compose_remove_reedit_target (Compose * compose)
{
  FolderItem *item;
  ...
  if (procmsg_msg_exist (msginfo) && (item->stype == F_DRAFT || item->stype == F_QUEUE))
    {
...
static gint
compose_queue (Compose * compose, const gchar * file)
{
  FolderItem *queue;
  gchar *tmp;
  FILE *fp, *src_fp;
  ...
  g_return_val_if_fail (compose->to_list != NULL || compose->newsgroup_list != NULL, -1);
  g_return_val_if_fail (compose->account != NULL, -1);

  tmp = g_strdup_printf ("%s%cqueue.%p", get_tmp_dir (), G_DIR_SEPARATOR, compose);
  ...
  if (compose->mode == COMPOSE_REEDIT)
    {
      compose_remove_reedit_target (compose);
      if (compose->targetinfo && compose->targetinfo->folder != queue)
        folderview_update_item (compose->targetinfo->folder, TRUE);
    }
...
static gint
compose_write_attach (Compose * compose, FILE * fp, const gchar * charset)
{
  GtkTreeModel *model = GTK_TREE_MODEL (compose->attach_store);
  GtkTreeIter iter;
  gboolean valid;
  ...
  for (valid = gtk_tree_model_get_iter_first (model, &iter); valid; valid = gtk_tree_model_iter_next (model, &iter))
    {
      ...
      if (!is_file_exist (ainfo->file))
        {
          alertpanel_error (_("File %s doesn't exist."), ainfo->file);
          return -1;
        }
      ...
      if (!g_ascii_strncasecmp (ainfo->content_type, "message/", 8))
        ...
        {
          if (prefs_common.mime_fencoding_method == FENC_RFC2231)
            {
              gchar *param;

              param = compose_convert_filename (compose, ainfo->name, "name", charset);
              fprintf (fp, "Content-Type: %s;\n" "%s\n", ainfo->content_type, param);
              g_free (param);
              param = compose_convert_filename (compose, ainfo->name, "filename", charset);
          ...
          else
            {
              ...
              compose_convert_header (compose, filename, sizeof (filename), ainfo->name, 12, FALSE, charset);
          ...
          if (rfc2015_is_available () && compose->use_signing && !compose->account->clearsign)
            {
              if (encoding == ENC_7BIT)
                encoding = ENC_QUOTED_PRINTABLE;
              else if (encoding == ENC_8BIT)
      ...
      if (encoding == ENC_BASE64)
        {
          ...
          while ((len = fread (inbuf, sizeof (gchar), B64_LINE_SIZE, src_fp)) == B64_LINE_SIZE)
            {
              base64_encode (outbuf, (guchar *) inbuf, B64_LINE_SIZE);
              fputs (outbuf, fp);
              fputc ('\n', fp);
            }
...
static gint
compose_write_headers (Compose * compose, FILE * fp,
                       const gchar * charset, const gchar * body_charset, EncodingType encoding, gboolean is_draft)
{
  gchar buf[BUFFSIZE];
  ...
  if (compose->account->name && *compose->account->name)
    {
      compose_convert_header (compose, buf, sizeof (buf), compose->account->name, strlen ("From: "), TRUE, charset);
      ...
      if (*entry_str != '\0')
        {
          ...
          if (*str != '\0')
            {
              compose->newsgroup_list = newsgroup_list_append (compose->newsgroup_list, str);
              compose_convert_header (compose, buf, sizeof (buf), str, strlen ("Newsgroups: "), FALSE, charset);
  ...
  if (*entry_str != '\0' && !IS_IN_CUSTOM_HEADER ("Subject"))
    {
      ...
      if (*str != '\0')
        {
          compose_convert_header (compose, buf, sizeof (buf), str, strlen ("Subject: "), FALSE, charset);
      ...
      if (*entry_str != '\0')
        {
          ...
          if (*str != '\0')
            {
              compose_convert_header (compose, buf, sizeof (buf), str, strlen ("Followup-To: "), FALSE, charset);
      ...
      if (*entry_str != '\0')
        {
          ...
          if (*str != '\0')
            {
              compose_convert_header (compose, buf, sizeof (buf), str, strlen ("Reply-To: "), TRUE, charset);
  ...
  if (compose->use_mdn && !IS_IN_CUSTOM_HEADER ("Disposition-Notification-To"))
  ...
  if (compose->account->organization && !IS_IN_CUSTOM_HEADER ("Organization"))
    {
      compose_convert_header (compose, buf, sizeof (buf),
                              compose->account->organization, strlen ("Organization: "), FALSE, charset);
      ...
      for (cur = compose->account->customhdr_list; cur != NULL; cur = cur->next)
        {
          ...
          if (g_ascii_strcasecmp (chdr->name, "Date") != 0 &&
              g_ascii_strcasecmp (chdr->name, "From") != 0 && g_ascii_strcasecmp (chdr->name, "To") != 0 &&
            ...
            {
              compose_convert_header
                (compose, buf, sizeof (buf), chdr->value ? chdr->value : "", strlen (chdr->name) + 2, FALSE, charset);
              fprintf (fp, "%s: %s\n", chdr->name, buf);
            }
        }
    }
  ...
  if (is_draft)
    {
      fprintf (fp, "X-YAM-Account-Id: %d\n", compose->account->account_id);
      if (compose->reply_target)
        fprintf (fp, "X-YAM-Reply: %s\n", compose->reply_target);
      else if (compose->forward_targets)
        fprintf (fp, "X-YAM-Forward: %s\n", compose->forward_targets);
      fprintf (fp, "X-YAM-Compose-AutoWrap: %s\n", compose->autowrap ? "TRUE" : "FALSE");
#if USE_GSPELL
      fprintf (fp, "X-YAM-Compose-CheckSpell: %s\n", compose->check_spell ? "TRUE" : "FALSE");
      if (compose->spell_lang)
        fprintf (fp, "X-YAM-Compose-SpellLang: %s\n", compose->spell_lang);
#endif
#if USE_GPGME
      fprintf (fp, "X-YAM-Compose-UseSigning: %s\n", compose->use_signing ? "TRUE" : "FALSE");
      fprintf (fp, "X-YAM-Compose-UseEncryption: %s\n", compose->use_encryption ? "TRUE" : "FALSE");
#endif
    }
...
static gint
compose_redirect_write_headers (Compose * compose, FILE * fp)
{
  gchar buf[BUFFSIZE];
  const gchar *entry_str;
  gchar *str;
  ...
  if (compose->account->name)
    {
      compose_convert_header (compose, buf, sizeof (buf), compose->account->name, strlen ("Resent-From: "), TRUE, NULL);
      ...
      if (*entry_str != '\0')
        {
          ...
          if (*str != '\0')
            {
              compose->newsgroup_list = newsgroup_list_append (compose->newsgroup_list, str);
              compose_convert_header (compose, buf, sizeof (buf), str, strlen ("Newsgroups: "), FALSE, NULL);
              fprintf (fp, "Newsgroups: %s\n", buf);
            }
          g_free (str);
        }
  ...
  if (*entry_str != '\0')
    {
      ...
      if (*str != '\0')
        {
          compose_convert_header (compose, buf, sizeof (buf), str, strlen ("Subject: "), FALSE, NULL);
          fprintf (fp, "Subject: %s\n", buf);
        }
      g_free (str);
    }
      ...
      if (*entry_str != '\0')
        {
          ...
          if (*str != '\0')
            {
              compose_convert_header (compose, buf, sizeof (buf), str, strlen ("Followup-To: "), FALSE, NULL);
              fprintf (fp, "Followup-To: %s\n", buf);
            }
          g_free (str);
        }
      ...
      if (*entry_str != '\0')
        {
          ...
          if (*str != '\0')
            {
              compose_convert_header (compose, buf, sizeof (buf), str, strlen ("Resent-Reply-To: "), TRUE, NULL);
...
static void
compose_convert_header (Compose * compose, gchar * dest, gint len,
                        const gchar * src, gint header_len, gboolean addr_field, const gchar * encoding)
{
  gchar *src_;
...
static gchar *
compose_convert_filename (Compose * compose, const gchar * src, const gchar * param_name, const gchar * encoding)
{
  gchar *str;
...
static void
compose_generate_msgid (Compose * compose, gchar * buf, gint len)
{
  struct tm *lt;
  time_t t;
  const gchar *addr, *p;
  ...
  if (compose->account && compose->account->address && *compose->account->address)
    {
  ...
  g_snprintf (hash_str, sizeof (hash_str), "%08x%s", g_random_int (), addr_left);
  ...
  g_snprintf (buf, len, "%04d%02d%02d%02d%02d%02d.%.24s@%s",
              lt->tm_year + 1900, lt->tm_mon + 1, lt->tm_mday, lt->tm_hour, lt->tm_min, lt->tm_sec, md5str, addr_right);
...
static void
compose_add_entry_field (GtkWidget * table, GtkWidget ** hbox, GtkWidget ** entry,
                         gint * count, const gchar * label_str, gboolean is_addr_entry)
{
  *hbox = gtk_label_new (prefs_common.trans_hdr ? gettext (label_str) : label_str);
  gtk_label_set_xalign (GTK_LABEL (*hbox), 1.0);
  gtk_grid_attach (GTK_GRID (table), *hbox, 0, *count, 1, 1);
  *entry = gtk_entry_new ();
  gtk_widget_set_hexpand (*entry, TRUE);
  gtk_entry_set_max_length (GTK_ENTRY (*entry), MAX_ENTRY_LENGTH);
  gtk_grid_attach (GTK_GRID (table), *entry, 1, *count, 1, 1);
...
static Compose *
compose_create (PrefsAccount * account, ComposeMode mode)
{
  Compose *compose;
  GtkWidget *window;
  GtkWidget *vbox;
  ...
  window = gtk_window_new (GTK_WINDOW_TOPLEVEL);
  gtk_window_set_default_size (GTK_WINDOW (window), -1, prefs_common.compose_height);
  yam_window_move (GTK_WINDOW (window), prefs_common.compose_x, prefs_common.compose_y);

  if (!geometry.max_width)
    yam_screen_get_size (gtk_widget_get_window (window), &geometry.max_width, &geometry.max_height);
  ...
  menubar = menubar_create (window, compose_entries, n_menu_entries, "<Compose>", compose);
  ...
  table_vbox = gtk_box_new (GTK_ORIENTATION_VERTICAL, 0);
  ...
  from_optmenu_hbox = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 0);
  gtk_grid_attach (GTK_GRID (table), from_optmenu_hbox, 1, count, 1, 1);
  ...
  compose_add_entry_field (table, &to_hbox, &to_entry, &count, "To:", TRUE);
  compose_add_entry_field (table, &newsgroups_hbox, &newsgroups_entry, &count, "Newsgroups:", FALSE);
  compose_add_entry_field (table, &cc_hbox, &cc_entry, &count, "Cc:", TRUE);
  compose_add_entry_field (table, &bcc_hbox, &bcc_entry, &count, "Bcc:", TRUE);
  compose_add_entry_field (table, &reply_hbox, &reply_entry, &count, "Reply-To:", TRUE);
  compose_add_entry_field (table, &followup_hbox, &followup_entry, &count, "Followup-To:", FALSE);
  compose_add_entry_field (table, &hbox, &subject_entry, &count, "Subject:", FALSE);

  gtk_grid_set_column_spacing (GTK_GRID (table), 5);

  g_signal_connect (G_OBJECT (to_entry), "activate", G_CALLBACK (to_activated), compose);
  g_signal_connect (G_OBJECT (newsgroups_entry), "activate", G_CALLBACK (newsgroups_activated), compose);
  g_signal_connect (G_OBJECT (cc_entry), "activate", G_CALLBACK (cc_activated), compose);
  g_signal_connect (G_OBJECT (bcc_entry), "activate", G_CALLBACK (bcc_activated), compose);
  g_signal_connect (G_OBJECT (reply_entry), "activate", G_CALLBACK (replyto_activated), compose);
  g_signal_connect (G_OBJECT (followup_entry), "activate", G_CALLBACK (followupto_activated), compose);
  g_signal_connect (G_OBJECT (subject_entry), "activate", G_CALLBACK (subject_activated), compose);

  g_signal_connect (G_OBJECT (to_entry), "grab_focus", G_CALLBACK (compose_grab_focus_cb), compose);
  g_signal_connect (G_OBJECT (newsgroups_entry), "grab_focus", G_CALLBACK (compose_grab_focus_cb), compose);
  g_signal_connect (G_OBJECT (cc_entry), "grab_focus", G_CALLBACK (compose_grab_focus_cb), compose);
  g_signal_connect (G_OBJECT (bcc_entry), "grab_focus", G_CALLBACK (compose_grab_focus_cb), compose);
  g_signal_connect (G_OBJECT (reply_entry), "grab_focus", G_CALLBACK (compose_grab_focus_cb), compose);
  g_signal_connect (G_OBJECT (followup_entry), "grab_focus", G_CALLBACK (compose_grab_focus_cb), compose);
  g_signal_connect (G_OBJECT (subject_entry), "grab_focus", G_CALLBACK (compose_grab_focus_cb), compose);

#if USE_GPGME
  misc_hbox = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 0);
  ...
  g_signal_connect (G_OBJECT (signing_chkbtn), "toggled", G_CALLBACK (compose_signing_toggled), compose);
  g_signal_connect (G_OBJECT (encrypt_chkbtn), "toggled", G_CALLBACK (compose_encrypt_toggled), compose);
#endif /* USE_GPGME */

  /* attachment list */
  attach_scrwin = gtk_scrolled_window_new (NULL, NULL);
  gtk_scrolled_window_set_policy (GTK_SCROLLED_WINDOW (attach_scrwin), GTK_POLICY_AUTOMATIC, GTK_POLICY_ALWAYS);
  gtk_scrolled_window_set_shadow_type (GTK_SCROLLED_WINDOW (attach_scrwin), GTK_SHADOW_IN);
  gtk_widget_set_size_request (attach_scrwin, -1, 80);

  store = gtk_list_store_new (N_ATTACH_COLS, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_POINTER);
  ...
  gtk_tree_view_set_search_column (GTK_TREE_VIEW (attach_treeview), COL_NAME);
  ...
  renderer = gtk_cell_renderer_text_new ();
  g_object_set (renderer, "ypad", 0, NULL);
  column = gtk_tree_view_column_new_with_attributes (_("Data type"), renderer, "text", COL_MIMETYPE, NULL);
  ...
  g_signal_connect (G_OBJECT (selection), "changed", G_CALLBACK (attach_selection_changed), compose);
  g_signal_connect (G_OBJECT (attach_treeview), "button_press_event", G_CALLBACK (attach_button_pressed), compose);
  g_signal_connect (G_OBJECT (attach_treeview), "key_press_event", G_CALLBACK (attach_key_pressed), compose);

  /* drag and drop */
  gtk_drag_dest_set (window, GTK_DEST_DEFAULT_ALL, compose_drag_types, N_DRAG_TYPES, GDK_ACTION_COPY | GDK_ACTION_MOVE);
  g_signal_connect (G_OBJECT (window), "drag-data-received", G_CALLBACK (compose_attach_drag_received_cb), compose);

  /* pane between attach tree view and text */
  paned = gtk_paned_new (GTK_ORIENTATION_VERTICAL);
  gtk_paned_add1 (GTK_PANED (paned), attach_scrwin);
  g_object_ref (G_OBJECT (paned));
  ...
  /* drag and drop */
  gtk_drag_dest_set (text, GTK_DEST_DEFAULT_ALL, compose_drag_types, N_DRAG_TYPES, GDK_ACTION_COPY | GDK_ACTION_MOVE);
  g_signal_connect (G_OBJECT (text), "drag-data-received", G_CALLBACK (compose_insert_drag_received_cb), compose);
  ...
  if (prefs_common.textfont)
    {
      ...
      if (font_desc)
        {
          yam_text_view_modify_font (text, font_desc);
          pango_font_description_free (font_desc);
        }
    }

  gtk_text_view_set_pixels_above_lines (GTK_TEXT_VIEW (text), prefs_common.line_space - prefs_common.line_space / 2);
  gtk_text_view_set_pixels_below_lines (GTK_TEXT_VIEW (text), prefs_common.line_space / 2);
  gtk_text_view_set_pixels_inside_wrap (GTK_TEXT_VIEW (text), prefs_common.line_space);

  n_entries = sizeof (compose_popup_entries) / sizeof (compose_popup_entries[0]);
  popupmenu = menu_create_items (compose_popup_entries, n_entries, "<Compose>", &popupfactory, compose);
...
#if USE_GSPELL
  spell_menu = gtk_item_factory_get_item (ifactory, "/Tools/Set spell language");
#endif
  ...
  undo_set_change_state_func (undostruct, &compose_undo_state_changed, menubar);
  ...
  g_signal_connect (G_OBJECT (window), "window_state_event", G_CALLBACK (compose_window_state_cb), compose);
  ...
  if (mode == COMPOSE_REDIRECT)
    {
      ...
      menu_set_sensitive (ifactory, "/Tools/Set spell language", FALSE);
#endif
      ...
      menu_set_sensitive_all (GTK_MENU_SHELL (compose->popupmenu), FALSE);
    }
  ...
  if (mode != COMPOSE_REDIRECT)
    menu_set_active (ifactory, "/Tools/Check spell", prefs_common.check_spell);
#endif
...
static Compose *
compose_find_window_by_target (MsgInfo * msginfo)
{
  GList *cur;
  Compose *compose;
...
static void
compose_connect_changed_callbacks (Compose * compose)
{
  GtkTextView *text = GTK_TEXT_VIEW (compose->text);
  GtkTextBuffer *buffer;
  ...
  g_signal_connect (G_OBJECT (buffer), "changed", G_CALLBACK (compose_buffer_changed_cb), compose);
  g_signal_connect (G_OBJECT (compose->to_entry), "changed", G_CALLBACK (compose_changed_cb), compose);
  g_signal_connect (G_OBJECT (compose->newsgroups_entry), "changed", G_CALLBACK (compose_changed_cb), compose);
  g_signal_connect (G_OBJECT (compose->cc_entry), "changed", G_CALLBACK (compose_changed_cb), compose);
  g_signal_connect (G_OBJECT (compose->bcc_entry), "changed", G_CALLBACK (compose_changed_cb), compose);
  g_signal_connect (G_OBJECT (compose->reply_entry), "changed", G_CALLBACK (compose_changed_cb), compose);
  g_signal_connect (G_OBJECT (compose->followup_entry), "changed", G_CALLBACK (compose_changed_cb), compose);
  g_signal_connect (G_OBJECT (compose->subject_entry), "changed", G_CALLBACK (compose_changed_cb), compose);
}
...
static GtkWidget *
compose_toolbar_create (Compose * compose)
{
  GtkWidget *toolbar;
  const gchar *setting;
  GList *item_list;

  if (prefs_common.compose_toolbar_setting && *prefs_common.compose_toolbar_setting != '\0')
...
static GtkWidget *
compose_toolbar_create_from_list (Compose * compose, GList * item_list)
{
  GtkWidget *toolbar;
  GtkWidget *icon_wid;
  ...
  g_signal_connect (G_OBJECT (toolbar), "button_press_event", G_CALLBACK (toolbar_button_pressed), compose);
  ...
  for (cur = item_list; cur != NULL; cur = cur->next)
    {
      ...
      icon_wid = stock_pixbuf_widget (ditem->icon);
      toolitem = gtk_tool_button_new (icon_wid, gettext (ditem->label));
      if (ditem->description)
        gtk_tool_item_set_tooltip_text (toolitem, gettext (ditem->description));

      yam_get_str_size (GTK_WIDGET (toolitem), gettext (ditem->label), &width, NULL);
      gtk_tool_item_set_homogeneous (toolitem, width < 52 ? TRUE : FALSE);
      gtk_tool_item_set_is_important (toolitem, item->is_important);

      gtk_toolbar_insert (GTK_TOOLBAR (toolbar), toolitem, -1);

      g_signal_connect (G_OBJECT (toolitem), "clicked", G_CALLBACK (item->callback), compose);
      g_signal_connect (G_OBJECT (gtk_bin_get_child (GTK_BIN (toolitem))),
                        "button_press_event", G_CALLBACK (toolbar_button_pressed), compose);
...
static void
compose_set_toolbar_button_visibility (Compose * compose)
{
...
static GtkWidget *
compose_account_option_menu_create (Compose * compose, GtkWidget * hbox)
{
  GList *accounts;
  GtkWidget *optmenu;
  GtkListStore *store;
  ...
  optmenu = gtk_combo_box_new_with_model (GTK_TREE_MODEL (store));
  gtk_box_pack_start (GTK_BOX (hbox), optmenu, FALSE, FALSE, 0);

  renderer = gtk_cell_renderer_text_new ();
  gtk_cell_layout_pack_start (GTK_CELL_LAYOUT (optmenu), renderer, TRUE);
  gtk_cell_layout_set_attributes (GTK_CELL_LAYOUT (optmenu), renderer, "text", 0, NULL);
  ...
  for (; accounts != NULL; accounts = accounts->next, num++)
    {
      ...
      if (ac->name)
        name = g_strdup_printf ("%s: %s <%s>", ac->account_name, ac->name, ac->address);
      else
        name = g_strdup_printf ("%s: %s", ac->account_name, ac->address);

      gtk_list_store_append (store, &iter);
      gtk_list_store_set (store, &iter, 0, name, 1, ac, -1);
    }
...
static GtkWidget *
compose_signature_menu_create (Compose * compose, GtkWidget * hbox)
{
  GtkWidget *label;
  GtkWidget *combo;
  gint i;
  ...
  g_signal_connect (GTK_COMBO_BOX (combo), "changed", G_CALLBACK (sig_combo_changed), compose);
...
static void
compose_set_out_encoding (Compose * compose)
{
  ...
  for (entry = compose_entries; entry->callback != compose_address_cb; entry++)
    {
      if (entry->callback == compose_set_encoding_cb && (CharSet) entry->callback_action == out_encoding)
        {
...
#if USE_GSPELL
static void
compose_set_spell_lang_menu (Compose * compose)
{
  GList *dict_list = NULL, *cur;
  GSList *menu_list = NULL;
  GtkWidget *menu;
  const gchar *def_dict;
  gboolean lang_set = FALSE;

  dict_list = gspell_language_get_available ();
  def_dict = gspell_language_get_code (gspell_language_get_default ());

  menu = gtk_menu_new ();

  for (cur = dict_list; cur != NULL; cur = cur->next)
    {
      GspellLanguage *lang = (GspellLanguage *) cur->data;
      const gchar *dict, *name;
      GtkWidget *item;
      ...
      dict = gspell_language_get_code (lang);

      item = gtk_radio_menu_item_new_with_label (menu_list, name);
      menu_list = gtk_radio_menu_item_get_group (GTK_RADIO_MENU_ITEM (item));
      if (compose->spell_lang != NULL && g_ascii_strcasecmp (compose->spell_lang, dict) == 0)
        {
          gtk_check_menu_item_set_active (GTK_CHECK_MENU_ITEM (item), TRUE);
          lang_set = TRUE;
        }
      gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
      g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (compose_set_spell_lang_cb), compose);
      g_object_set_data (G_OBJECT (item), "spell-lang", g_strdup (dict));
      gtk_widget_show (item);

      if (!lang_set && def_dict && g_ascii_strcasecmp (def_dict, dict) == 0)
        {
          g_free (compose->spell_lang);
...
static void
compose_change_spell_lang_menu (Compose * compose, const gchar * lang)
{
  GtkWidget *menu;
  ...
  for (cur_item = gtk_container_get_children (GTK_CONTAINER (menu)); cur_item != NULL; cur_item = cur_item->next)
    {
      ...
      if (dict && !g_ascii_strcasecmp (dict, lang))
        {
          gtk_check_menu_item_set_active (GTK_CHECK_MENU_ITEM (cur_item->data), TRUE);
          return;
        }
    }
  ...
  if (def_item)
    {
      gtk_check_menu_item_set_active (GTK_CHECK_MENU_ITEM (def_item), TRUE);
...
static void
compose_set_template_menu (Compose * compose)
{
...
void
compose_reflect_prefs_all (void)
{
  GList *cur;
  Compose *compose;
  ...
  for (cur = compose_list; cur != NULL; cur = cur->next)
    {
      ...
      if (prefs_common.enable_autosave && prefs_common.autosave_itv > 0 && compose->mode != COMPOSE_REDIRECT)
        compose->autosave_tag =
          g_timeout_add_full (G_PRIORITY_LOW, prefs_common.autosave_itv * 60 * 1000, autosave_timeout, compose, NULL);
    }
}
...
GtkWidget *
compose_get_toolbar (Compose * compose)
{
...
GtkWidget *
compose_get_misc_hbox (Compose * compose)
{
  g_return_val_if_fail (compose != NULL, NULL);
...
GtkWidget *
compose_get_textview (Compose * compose)
{
  g_return_val_if_fail (compose != NULL, NULL);
  return compose->text;
}
...
static void
compose_template_apply (Compose * compose, Template * tmpl, gboolean replace)
{
  GtkTextView *text = GTK_TEXT_VIEW (compose->text);
  GtkTextBuffer *buffer;
  GtkTextMark *mark;
  ...
  if (tmpl->replyto && *tmpl->replyto != '\0')
    compose_entry_set (compose, tmpl->replyto, COMPOSE_ENTRY_REPLY_TO);
  ...
  if (compose->reply_target)
    {
      ...
      item = folder_find_item_and_num_from_id (compose->reply_target, &num);
      if (item && num > 0)
        {
      ...
      parsed_str = compose_quote_fmt (compose, msginfo, tmpl->value, prefs_common.quotemark, NULL);
      procmsg_msginfo_free (msginfo);
    }
  else if (compose->forward_targets)
    {
      ...
      for (i = 0; targets[i] != NULL; i++)
        {
          ...
          parsed_str = compose_quote_fmt (compose, full_msginfo ? full_msginfo : msginfo,
                                          tmpl->value, prefs_common.fw_quotemark, NULL);
          procmsg_msginfo_free (full_msginfo);
          procmsg_msginfo_free (msginfo);
        }
      g_strfreev (targets);
    ...
    parsed_str = compose_quote_fmt (compose, NULL, tmpl->value, NULL, NULL);
...
static void
compose_destroy (Compose * compose)
{
  GtkTreeModel *model = GTK_TREE_MODEL (compose->attach_store);
  GtkTreeIter iter;
  gboolean valid;
  ...
  yam_plugin_signal_emit ("compose-destroy", compose);
  ...
  if (!prefs_common.compose_maximized)
    {
      yam_widget_get_uposition (compose->window, &prefs_common.compose_x, &prefs_common.compose_y);
      gtk_window_get_size (GTK_WINDOW (compose->window), &prefs_common.compose_width, &prefs_common.compose_height);
    }
...
static void
compose_attach_info_free (AttachInfo * ainfo)
{
  g_free (ainfo->file);
...
static void
compose_attach_remove_selected (Compose * compose)
{
  GtkTreeModel *model = GTK_TREE_MODEL (compose->attach_store);
  GtkTreeSelection *selection;
  GtkTreeIter iter;
  ...
  selection = gtk_tree_view_get_selection (GTK_TREE_VIEW (compose->attach_treeview));
...
void
compose_attach_remove_all (Compose * compose)
{
  GtkTreeModel *model = GTK_TREE_MODEL (compose->attach_store);
  GtkTreeIter iter;
  AttachInfo *ainfo;
...
GSList *
compose_get_attach_list (Compose * compose)
{
  GtkTreeModel *model = GTK_TREE_MODEL (compose->attach_store);
  GtkTreeIter iter;
  gboolean valid;
...
static void
compose_attach_property (Compose * compose)
{
  GtkTreeModel *model = GTK_TREE_MODEL (compose->attach_store);
  GtkTreeSelection *selection;
  GtkTreeIter iter;
  ...
  if (ainfo->encoding == ENC_UNKNOWN)
    gtk_combo_box_set_active (optmenu, ENC_BASE64);
  else
    gtk_combo_box_set_active (optmenu, ainfo->encoding);
  ...
  for (;;)
    {
      ...
      ainfo->encoding = gtk_combo_box_get_active (GTK_COMBO_BOX (optmenu));

      entry_text = gtk_entry_get_text (GTK_ENTRY (attach_prop.path_entry));
      if (*entry_text != '\0')
        {
          file = conv_filename_from_utf8 (entry_text);
          if (!is_file_exist (file) || (size = get_file_size (file)) <= 0)
            {
      ...
      gtk_list_store_set (compose->attach_store, &iter, COL_MIMETYPE, ainfo->content_type,
                          COL_SIZE, to_human_readable (ainfo->size), COL_NAME, ainfo->name, -1);
      break;
    }
...
static void
compose_attach_property_create (gboolean * cancelled)
{
  GtkWidget *window;
  GtkWidget *vbox;
  GtkWidget *table;
  ...
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), "7bit");
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), "8bit");
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), "quoted-printable");
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), "base64");
...
static void
attach_property_ok (GtkWidget * widget, gboolean * cancelled)
{
  *cancelled = FALSE;
  gtk_main_quit ();
}
...
static void
attach_property_cancel (GtkWidget * widget, gboolean * cancelled)
{
  *cancelled = TRUE;
  gtk_main_quit ();
}
...
static gint
attach_property_delete_event (GtkWidget * widget, GdkEventAny * event, gboolean * cancelled)
{
  *cancelled = TRUE;
  gtk_main_quit ();
...
static void
compose_attach_open (Compose * compose)
{
  GtkTreeModel *model = GTK_TREE_MODEL (compose->attach_store);
  GtkTreeSelection *selection;
  GtkTreeIter iter;
...
static void
compose_exec_ext_editor (Compose * compose)
{
  gchar *tmp;
  GPid pid;
  ...
  tmp = g_strdup_printf ("%s%ctmpmsg-%p.txt", get_tmp_dir (), G_DIR_SEPARATOR, compose);

  if (compose_write_body_to_file (compose, tmp) < 0)
    {
      g_warning ("Couldn't write to file: %s\n", tmp);
      g_free (tmp);
      return;
    }

  if (prefs_common.ext_editor_cmd && str_find_format_times (prefs_common.ext_editor_cmd, 's') == 1)
  ...
  if (g_spawn_async (NULL, cmdline, NULL,
                     G_SPAWN_DO_NOT_REAP_CHILD | G_SPAWN_SEARCH_PATH, NULL, NULL, &pid, &error) == FALSE)
    {
  ...
  compose->exteditor_tag = g_child_watch_add (pid, compose_ext_editor_child_exit, compose);
}

static gboolean
compose_ext_editor_kill (Compose * compose)
{
  gint ret;
  ...
  if (ret == 0 || (ret == -1 && EPERM == errno))
    {
      ...
      val = alertpanel_full (_("Notice"), msg, ALERT_NOTICE, G_ALERTALTERNATE, FALSE, "yam-yes", "yam-no", NULL);
      g_free (msg);
...
static void
compose_ext_editor_child_exit (GPid pid, gint status, gpointer data)
{
...
static void
compose_set_ext_editor_sensitive (Compose * compose, gboolean sensitive)
{
  GtkItemFactory *ifactory;
  ...
  menu_set_sensitive (ifactory, "/File/Save to draft folder", sensitive);
  ...
  menu_set_sensitive (ifactory, "/Tools/Edit with external editor", sensitive);
 ...
 **/
static void
compose_undo_state_changed (UndoMain * undostruct, gint undo_state, gint redo_state, gpointer data)
{
...
/* callback functions */
static void
toolbar_send_cb (GtkWidget * widget, gpointer data)
{
  compose_send ((Compose *) data, TRUE);
}

static void
toolbar_send_later_cb (GtkWidget * widget, gpointer data)
{
  compose_send_later_cb (data, 0, NULL);
}

static void
toolbar_draft_cb (GtkWidget * widget, gpointer data)
{
  compose_draft_cb (data, 0, NULL);
}

static void
toolbar_insert_cb (GtkWidget * widget, gpointer data)
{
  compose_insert_file_cb (data, 0, NULL);
}

static void
toolbar_attach_cb (GtkWidget * widget, gpointer data)
{
  compose_attach_cb (data, 0, NULL);
}

static void
toolbar_sig_cb (GtkWidget * widget, gpointer data)
{
  Compose *compose = (Compose *) data;
...
static void
toolbar_ext_editor_cb (GtkWidget * widget, gpointer data)
{
  Compose *compose = (Compose *) data;
...
static void
toolbar_linewrap_cb (GtkWidget * widget, gpointer data)
{
  Compose *compose = (Compose *) data;
...
static void
toolbar_address_cb (GtkWidget * widget, gpointer data)
{
  compose_address_cb (data, 0, NULL);
}

static void
toolbar_prefs_common_cb (GtkWidget * widget, gpointer data)
{
  prefs_common_open ();
}

static void
toolbar_prefs_account_cb (GtkWidget * widget, gpointer data)
{
  account_open (cur_account);
}

static void
toolbar_customize (GtkWidget * widget, gpointer data)
{
  Compose *compose = (Compose *) data;
  gint *visible_items;
  ...
  if (ret == 0)
    {
      ...
      toolbar = compose_toolbar_create_from_list (compose, item_list);
      gtk_widget_set_size_request (toolbar, 300, -1);
      gtk_box_pack_start (GTK_BOX (compose->vbox), toolbar, FALSE, FALSE, 0);
      gtk_box_reorder_child (GTK_BOX (compose->vbox), toolbar, 1);
      compose->toolbar = toolbar;
      compose_set_toolbar_button_visibility (compose);
      g_free (prefs_common.compose_toolbar_setting);
      prefs_common.compose_toolbar_setting = prefs_toolbar_get_name_list_from_item_list (item_list);
      g_list_free (item_list);
      prefs_common_write_config ();

      yam_plugin_signal_emit ("compose-toolbar-changed", compose);
    }
}

static gboolean
toolbar_button_pressed (GtkWidget * widget, GdkEventButton * event, gpointer data)
{
  Compose *compose = (Compose *) data;
  GtkWidget *menu;
  GtkWidget *menuitem;
  ...
  MENUITEM_ADD_WITH_MNEMONIC (menu, menuitem, _("_Customize toolbar..."), 0);
  g_signal_connect (G_OBJECT (menuitem), "activate", G_CALLBACK (toolbar_customize), compose);
  g_signal_connect (G_OBJECT (menu), "selection_done", G_CALLBACK (gtk_widget_destroy), NULL);
...
static void
account_activated (GtkComboBox *widget, gpointer data)
{
  Compose *compose = (Compose *) data;
  PrefsAccount *ac;
  GtkTreeModel *model;
  ...
  gtk_tree_model_get (model, &iter, 1, &ac, -1);
...
static void
sig_combo_changed (GtkComboBox * combo, gpointer data)
{
  Compose *compose = (Compose *) data;
...
static void
attach_selection_changed (GtkTreeSelection * selection, gpointer data)
{
}

static gboolean
attach_button_pressed (GtkWidget * widget, GdkEventButton * event, gpointer data)
{
  Compose *compose = (Compose *) data;
  ...
  if (event->button == 2 || (event->button == 1 && event->type == GDK_2BUTTON_PRESS))
  ...
  else if (event->button == 3)
    {
      ...
      gtk_menu_popup_at_pointer (GTK_MENU (compose->popupmenu), (GdkEvent *) event);
...
static gboolean
attach_key_pressed (GtkWidget * widget, GdkEventKey * event, gpointer data)
{
  Compose *compose = (Compose *) data;
...
gint
compose_send (Compose * compose, gboolean close_on_success)
{
  gint val;
...
static void
compose_send_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
...
static void
compose_send_later_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
  FolderItem *queue;
  gchar tmp[MAXPATHLEN + 1];
  ...
  yam_plugin_signal_emit ("compose-send", compose, compose->mode, 1, tmp, compose->to_list, &cancel);
  if (cancel)
    {
      g_unlink (tmp);
      C_UNLOCK ();
...
static void
compose_draft_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
  FolderItem *draft;
  gchar *tmp;
  ...
  if (compose->mode == COMPOSE_REEDIT)
    {
      compose_remove_reedit_target (compose);
      if (compose->targetinfo && compose->targetinfo->folder != draft)
        folderview_update_item (compose->targetinfo->folder, TRUE);
    }
...
static void
compose_attach_open_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
...
static void
compose_attach_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
  GSList *files;
  GSList *cur;

  files = filesel_select_files (_("Select files"), NULL, GTK_FILE_CHOOSER_ACTION_OPEN);
...
static void
compose_insert_file_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
  gchar *file;

  file = filesel_select_file (_("Select file"), NULL, GTK_FILE_CHOOSER_ACTION_OPEN);
...
static void
compose_insert_sig_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
...
static gint
compose_delete_cb (GtkWidget * widget, GdkEventAny * event, gpointer data)
{
...
static gint
compose_window_state_cb (GtkWidget * widget, GdkEventWindowState * event, gpointer data)
{
  Compose *compose = (Compose *) data;
...
static void
compose_close_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
  AlertValue val;
  ...
  if (compose->modified)
    {
      val = alertpanel (_("Save message"), _("This message has been modified. Save it to draft folder?"),
                        "yam-save", "yam-cancel", _("Close _without saving"));
...
static void
compose_set_encoding_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
...
static void
compose_address_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
...
static void
compose_template_activate_cb (GtkWidget * widget, gpointer data)
{
  Compose *compose = (Compose *) data;
  Template *tmpl;
  gchar *msg;
  ...
  val = alertpanel (_("Apply template"), msg, _("_Replace"), _("_Insert"), "yam-cancel");
  g_free (msg);
...
static void
compose_ext_editor_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
...
static void
compose_undo_cb (Compose * compose)
{
  gboolean prev_autowrap = compose->autowrap;
...
static void
compose_redo_cb (Compose * compose)
{
  gboolean prev_autowrap = compose->autowrap;
...
static void
compose_copy_cb (Compose * compose)
{
  if (compose->focused_editable && gtk_widget_has_focus (compose->focused_editable))
    {
      if (GTK_IS_EDITABLE (compose->focused_editable))
        gtk_editable_copy_clipboard (GTK_EDITABLE (compose->focused_editable));
      else if (GTK_IS_TEXT_VIEW (compose->focused_editable))
        {
          GtkTextView *text = GTK_TEXT_VIEW (compose->text);
          GtkTextBuffer *buffer;
...
static void
compose_paste_cb (Compose * compose)
{
  if (compose->focused_editable && gtk_widget_has_focus (compose->focused_editable))
    {
      if (GTK_IS_EDITABLE (compose->focused_editable))
        gtk_editable_paste_clipboard (GTK_EDITABLE (compose->focused_editable));
      else if (GTK_IS_TEXT_VIEW (compose->focused_editable))
        {
          GtkTextView *text = GTK_TEXT_VIEW (compose->text);
          GtkTextBuffer *buffer;
...
static void
compose_paste_as_quote_cb (Compose * compose)
{
  GtkTextView *text = GTK_TEXT_VIEW (compose->text);
  GtkTextBuffer *buffer;
  GtkTextMark *mark;
  ...
  if (!compose->focused_editable ||
      !gtk_widget_has_focus (compose->focused_editable) || !GTK_IS_TEXT_VIEW (compose->focused_editable))
    return;
...
static void
compose_allsel_cb (Compose * compose)
{
  if (compose->focused_editable && gtk_widget_has_focus (compose->focused_editable))
    {
      if (GTK_IS_EDITABLE (compose->focused_editable))
        gtk_editable_select_region (GTK_EDITABLE (compose->focused_editable), 0, -1);
      else if (GTK_IS_TEXT_VIEW (compose->focused_editable))
        {
          GtkTextView *text = GTK_TEXT_VIEW (compose->text);
          GtkTextBuffer *buffer;
...
static void
compose_grab_focus_cb (GtkWidget * widget, Compose * compose)
{
...
#if USE_GPGME
static void
compose_signing_toggled (GtkWidget * widget, Compose * compose)
{
  GtkItemFactory *ifactory;
...
static void
compose_encrypt_toggled (GtkWidget * widget, Compose * compose)
{
  GtkItemFactory *ifactory;
...
static void
compose_buffer_changed_cb (GtkTextBuffer * textbuf, Compose * compose)
{
...
static void
compose_changed_cb (GtkEditable * editable, Compose * compose)
{
  if (compose->block_modified == FALSE &&
      (compose->modified == FALSE || editable == GTK_EDITABLE (compose->subject_entry)))
    {
      compose->modified = TRUE;
      compose_set_title (compose);
    }
...
static void
compose_wrap_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
...
static void
compose_toggle_autowrap_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
...
static void
compose_toggle_to_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
...
static void
compose_toggle_cc_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
...
static void
compose_toggle_bcc_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
...
static void
compose_toggle_replyto_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
...
static void
compose_toggle_followupto_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
...
static void
compose_toggle_attach_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;

  if (gtk_check_menu_item_get_active (GTK_CHECK_MENU_ITEM (widget)))
    {
      g_object_ref (G_OBJECT (compose->edit_vbox));

      gtk_container_remove (GTK_CONTAINER (compose->vbox2), compose->edit_vbox);
      gtk_paned_add2 (GTK_PANED (compose->paned), compose->edit_vbox);
      gtk_box_pack_start (GTK_BOX (compose->vbox2), compose->paned, TRUE, TRUE, 0);
      gtk_widget_show (compose->paned);

      g_object_unref (G_OBJECT (compose->edit_vbox));
      g_object_unref (G_OBJECT (compose->paned));

      compose->use_attach = TRUE;
    }
  else
    {
      g_object_ref (G_OBJECT (compose->paned));
      g_object_ref (G_OBJECT (compose->edit_vbox));

      gtk_container_remove (GTK_CONTAINER (compose->vbox2), compose->paned);
      gtk_container_remove (GTK_CONTAINER (compose->paned), compose->edit_vbox);
      gtk_box_pack_start (GTK_BOX (compose->vbox2), compose->edit_vbox, TRUE, TRUE, 0);
...
static void
compose_customize_toolbar_cb (gpointer data, guint action, GtkWidget * widget)
{
  toolbar_customize (widget, data);
}

static void
compose_toggle_mdn_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
...
#if USE_GPGME
static void
compose_toggle_sign_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
  ...
  compose->use_signing = gtk_check_menu_item_get_active (GTK_CHECK_MENU_ITEM (widget));
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (compose->signing_chkbtn), compose->use_signing);
}

static void
compose_toggle_encrypt_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
  ...
  compose->use_encryption = gtk_check_menu_item_get_active (GTK_CHECK_MENU_ITEM (widget));
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (compose->encrypt_chkbtn), compose->use_encryption);
}
#endif /* USE_GPGME */

#if USE_GSPELL
static void
compose_toggle_spell_cb (gpointer data, guint action, GtkWidget * widget)
{
  Compose *compose = (Compose *) data;
  GspellTextView *sv;
  GspellTextBuffer *sb;
  ...
  if (gtk_check_menu_item_get_active (GTK_CHECK_MENU_ITEM (widget)))
    {
      ...
      sv = gspell_text_view_get_from_gtk_text_view (GTK_TEXT_VIEW (compose->text));
      gspell_text_view_basic_setup (sv);
      compose->check_spell = TRUE;
    }
  else
    {
      debug_print ("Spell checking disabled\n");
      sb = gspell_text_buffer_get_from_gtk_text_buffer (gtk_text_view_get_buffer (GTK_TEXT_VIEW (compose->text)));
      gspell_text_buffer_set_spell_checker (sb, NULL);
      compose->check_spell = FALSE;
    }
}

static void
compose_set_spell_lang_cb (GtkWidget * widget, gpointer data)
{
  Compose *compose = (Compose *) data;
  gchar *dict;
  GspellTextBuffer *sb;
  GspellChecker *speller;
  ...
  sb = gspell_text_buffer_get_from_gtk_text_buffer (gtk_text_view_get_buffer (GTK_TEXT_VIEW (compose->text)));
  speller = gspell_text_buffer_get_spell_checker (sb);
  if (speller)
    {
      const GspellLanguage *lang = gspell_language_lookup (dict);
      gspell_checker_set_language (speller, lang);
    }
...
static void
compose_attach_drag_received_cb (GtkWidget * widget, GdkDragContext * drag_context,
...
static void
compose_insert_drag_received_cb (GtkWidget * widget, GdkDragContext * drag_context,
                                 gint x, gint y, GtkSelectionData * data, guint info, guint time, gpointer user_data)
{
  ...
  if (context_ == drag_context && x_ == x && y_ == y && info_ == info && time_ == time)
    {
...
static void
to_activated (GtkWidget * widget, Compose * compose)
{
  if (gtk_widget_get_visible (compose->newsgroups_entry))
    gtk_widget_grab_focus (compose->newsgroups_entry);
  else if (gtk_widget_get_visible (compose->cc_entry))
    gtk_widget_grab_focus (compose->cc_entry);
  else if (gtk_widget_get_visible (compose->bcc_entry))
    gtk_widget_grab_focus (compose->bcc_entry);
  else if (gtk_widget_get_visible (compose->reply_entry))
    gtk_widget_grab_focus (compose->reply_entry);
  else if (gtk_widget_get_visible (compose->followup_entry))
...
static void
newsgroups_activated (GtkWidget * widget, Compose * compose)
{
  if (gtk_widget_get_visible (compose->cc_entry))
    gtk_widget_grab_focus (compose->cc_entry);
  else if (gtk_widget_get_visible (compose->bcc_entry))
    gtk_widget_grab_focus (compose->bcc_entry);
  else if (gtk_widget_get_visible (compose->reply_entry))
...
static void
cc_activated (GtkWidget * widget, Compose * compose)
{
  if (gtk_widget_get_visible (compose->bcc_entry))
    gtk_widget_grab_focus (compose->bcc_entry);
  else if (gtk_widget_get_visible (compose->reply_entry))
    gtk_widget_grab_focus (compose->reply_entry);
  else if (gtk_widget_get_visible (compose->followup_entry))
...
static void
bcc_activated (GtkWidget * widget, Compose * compose)
{
  if (gtk_widget_get_visible (compose->reply_entry))
    gtk_widget_grab_focus (compose->reply_entry);
  else if (gtk_widget_get_visible (compose->followup_entry))
    gtk_widget_grab_focus (compose->followup_entry);
  else
...
static void
replyto_activated (GtkWidget * widget, Compose * compose)
{
  if (gtk_widget_get_visible (compose->followup_entry))
    gtk_widget_grab_focus (compose->followup_entry);
  else
    gtk_widget_grab_focus (compose->subject_entry);
}
...
static void
followupto_activated (GtkWidget * widget, Compose * compose)
{
  gtk_widget_grab_focus (compose->subject_entry);
}

static void
subject_activated (GtkWidget * widget, Compose * compose)
{
  gtk_widget_grab_focus (compose->text);
}

static void
text_inserted (GtkTextBuffer * buffer, GtkTextIter * iter, const gchar * text, gint len, Compose * compose)
{
  GtkTextMark *mark;
...
static gboolean
autosave_timeout (gpointer data)
{
  Compose *compose = (Compose *) data;
