...
*/
ItemFolder *
addrcache_get_root_folder (AddressCache * cache)
{
...
GList *
addrcache_get_list_folder (AddressCache * cache)
{
  g_return_val_if_fail (cache != NULL, NULL);
...
GList *
addrcache_get_list_person (AddressCache * cache)
{
  g_return_val_if_fail (cache != NULL, NULL);
...
*/
void
addrcache_next_id (AddressCache * cache)
{
...
*/
void
addrcache_refresh (AddressCache * cache)
{
  cache->dataRead = FALSE;
  cache->modified = TRUE;
  cache->modifyTime = 0;
...
*/
static gint
addrcache_free_item_vis (gpointer key, gpointer value, gpointer data)
{
...
*/
static void
addrcache_free_item_hash (GHashTable * table)
{
...
*/
static void
addrcache_free_all_folders (ItemFolder * parent)
{
...
*/
void
addrcache_clear (AddressCache * cache)
{
  g_return_if_fail (cache != NULL);
...
*/
void
addrcache_free (AddressCache * cache)
{
  g_return_if_fail (cache != NULL);
...
*/
gboolean
addrcache_check_file (AddressCache * cache, gchar * path)
{
  gboolean retVal;
  GStatBuf filestat;
  retVal = TRUE;
...
*/
gboolean
addrcache_mark_file (AddressCache * cache, gchar * path)
{
...
*/
void
addrcache_print_item_list (GList * list, FILE * stream)
{
  GList *node = list;
  while (node)
    {
...
*/
static void
addrcache_print_item_vis (gpointer key, gpointer value, gpointer data)
{
  AddrItemObject *obj = (AddrItemObject *) value;
...
*/
void
addrcache_print (AddressCache * cache, FILE * stream)
{
  g_return_if_fail (cache != NULL);
...
*/
void
addrcache_dump_hash (AddressCache * cache, FILE * stream)
{
  g_return_if_fail (cache != NULL);
 ...
 */
void
addrcache_id_person (AddressCache * cache, ItemPerson * person)
{
  g_return_if_fail (cache != NULL);
 ...
 */
void
addrcache_id_group (AddressCache * cache, ItemGroup * group)
{
  g_return_if_fail (cache != NULL);
 ...
 */
void
addrcache_id_folder (AddressCache * cache, ItemFolder * folder)
{
  g_return_if_fail (cache != NULL);
 ...
 */
void
addrcache_id_email (AddressCache * cache, ItemEMail * email)
{
  g_return_if_fail (cache != NULL);
 ...
 */
void
addrcache_id_attribute (AddressCache * cache, UserAttribute * attrib)
{
  g_return_if_fail (cache != NULL);
...
*/
gboolean
addrcache_hash_add_person (AddressCache * cache, ItemPerson * person)
{
...
*/
gboolean
addrcache_hash_add_group (AddressCache * cache, ItemGroup * group)
{
...
*/
gboolean
addrcache_hash_add_folder (AddressCache * cache, ItemFolder * folder)
{
  g_return_val_if_fail (cache != NULL, FALSE);
...
*/
gboolean
addrcache_folder_add_person (AddressCache * cache, ItemFolder * folder, ItemPerson * item)
{
  gboolean retVal = FALSE;
...
*/
gboolean
addrcache_folder_add_folder (AddressCache * cache, ItemFolder * folder, ItemFolder * item)
{
  gboolean retVal = FALSE;
...
*/
gboolean
addrcache_folder_add_group (AddressCache * cache, ItemFolder * folder, ItemGroup * item)
{
  gboolean retVal = FALSE;
...
*/
gboolean
addrcache_add_person (AddressCache * cache, ItemPerson * person)
{
  gboolean retVal = FALSE;
...
*/
gboolean
addrcache_person_add_email (AddressCache * cache, ItemPerson * person, ItemEMail * email)
{
  g_return_val_if_fail (cache != NULL, FALSE);
  g_return_val_if_fail (person != NULL, FALSE);
...
*/
gboolean
addrcache_add_group (AddressCache * cache, ItemGroup * group)
{
  gboolean retVal = FALSE;
...
*/
gboolean
addrcache_group_add_email (AddressCache * cache, ItemGroup * group, ItemEMail * email)
{
  g_return_val_if_fail (cache != NULL, FALSE);
  g_return_val_if_fail (group != NULL, FALSE);
  g_return_val_if_fail (email != NULL, FALSE);
...
*/
gboolean
addrcache_add_folder (AddressCache * cache, ItemFolder * folder)
{
  gboolean retVal = FALSE;
...
*/
AddrItemObject *
addrcache_get_object (AddressCache * cache, const gchar * uid)
{
...
*/
ItemPerson *
addrcache_get_person (AddressCache * cache, const gchar * uid)
{
...
*/
ItemGroup *
addrcache_get_group (AddressCache * cache, const gchar * uid)
{
...
*/
ItemEMail *
addrcache_get_email (AddressCache * cache, const gchar * uid, const gchar * eid)
{
  AddrItemObject *objP;
...
*/
UserAttribute *
addrcache_person_remove_attrib_id (AddressCache * cache, const gchar * uid, const gchar * aid)
{
...
*/
UserAttribute *
addrcache_person_remove_attribute (AddressCache * cache, ItemPerson * person, UserAttribute * attrib)
{
...
*/
ItemGroup *
addrcache_remove_group_id (AddressCache * cache, const gchar * uid)
{
  AddrItemObject *obj = NULL;
...
*/
ItemGroup *
addrcache_remove_group (AddressCache * cache, ItemGroup * group)
{
  AddrItemObject *obj = NULL;
...
*/
static void
addrcache_allgrp_rem_person_vis (gpointer key, gpointer value, gpointer data)
{
  AddrItemObject *obj = (AddrItemObject *) value;
...
*/
static void
addrcache_allgrp_rem_email_vis (gpointer key, gpointer value, gpointer data)
{
  AddrItemObject *obj = (AddrItemObject *) value;
...
*/
ItemPerson *
addrcache_remove_person_id (AddressCache * cache, const gchar * uid)
{
  AddrItemObject *obj = NULL;
...
*/
ItemPerson *
addrcache_remove_person (AddressCache * cache, ItemPerson * person)
{
  AddrItemObject *obj = NULL;
...
*/
ItemEMail *
addrcache_person_remove_email_id (AddressCache * cache, const gchar * uid, const gchar * eid)
{
...
*/
ItemEMail *
addrcache_person_remove_email (AddressCache * cache, ItemPerson * person, ItemEMail * email)
{
...
*/
GList *
addrcache_folder_get_address_list (AddressCache * cache, ItemFolder * folder)
{
  GList *list = NULL;
  GList *node = NULL;
  ItemFolder *f = folder;
...
*/
GList *
addrcache_folder_get_person_list (AddressCache * cache, ItemFolder * folder)
{
  ItemFolder *f = folder;
...
*/
GList *
addrcache_folder_get_group_list (AddressCache * cache, ItemFolder * folder)
{
  ItemFolder *f = folder;
...
*/
GList *
addrcache_folder_get_folder_list (AddressCache * cache, ItemFolder * folder)
{
  GList *node = NULL;
  GList *list = NULL;
  ItemFolder *f = folder;
...
*/
GList *
addrcache_get_address_list (AddressCache * cache)
{
  g_return_val_if_fail (cache != NULL, NULL);
...
*/
GList *
addrcache_get_person_list (AddressCache * cache)
{
  g_return_val_if_fail (cache != NULL, NULL);
...
*/
GList *
addrcache_get_group_list (AddressCache * cache)
{
  g_return_val_if_fail (cache != NULL, NULL);
...
*/
GList *
addrcache_get_folder_list (AddressCache * cache)
{
  g_return_val_if_fail (cache != NULL, NULL);
  return cache->rootFolder->listFolder;
}
...
*/
static void
addrcache_get_grp_person_vis (gpointer key, gpointer value, gpointer data)
{
  AddrItemObject *obj = (AddrItemObject *) value;
...
*/
GList *
addrcache_get_group_for_person (AddressCache * cache, ItemPerson * person)
{
  GList *list = NULL;
...
*/
ItemFolder *
addrcache_find_root_folder (ItemFolder * folder)
{
...
*/
static void
addrcache_get_all_persons_vis (gpointer key, gpointer value, gpointer data)
{
  AddrItemObject *obj = (AddrItemObject *) value;
...
*/
GList *
addrcache_get_all_persons (AddressCache * cache)
{
  GList *list = NULL;
...
*/
static void
addrcache_get_all_groups_vis (gpointer key, gpointer value, gpointer data)
{
  AddrItemObject *obj = (AddrItemObject *) value;
...
*/
GList *
addrcache_get_all_groups (AddressCache * cache)
{
  GList *list = NULL;
...
*/
ItemFolder *
addrcache_remove_folder (AddressCache * cache, ItemFolder * folder)
{
  AddrItemObject *obj = NULL;
...
*/
ItemFolder *
addrcache_remove_folder_delete (AddressCache * cache, ItemFolder * folder)
{
  AddrItemObject *obj = NULL;
...
*/
ItemPerson *
addrcache_add_contact (AddressCache * cache, ItemFolder * folder, const gchar * name,
