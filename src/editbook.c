...
*/
void
edit_book_status_show (gchar * msg)
{
...
static void
edit_book_ok (GtkWidget * widget, gboolean * cancelled)
{
  *cancelled = FALSE;
  gtk_main_quit ();
}
...
static void
edit_book_cancel (GtkWidget * widget, gboolean * cancelled)
{
  *cancelled = TRUE;
  gtk_main_quit ();
}
...
static gint
edit_book_delete_event (GtkWidget * widget, GdkEventAny * event, gboolean * cancelled)
{
  *cancelled = TRUE;
  gtk_main_quit ();
  return TRUE;
...
static void
edit_book_enable_buttons (gboolean enable)
{
...
static gchar *
edit_book_guess_file (AddressBookFile * abf)
{
  gchar *newFile = NULL;
  GList *fileList = NULL;
  gint fileNum = 1;
...
static void
addressbook_edit_book_create (gboolean * cancelled)
{
  GtkWidget *window;
  GtkWidget *vbox;
  GtkWidget *table;
  ...
  /* g_signal_connect (G_OBJECT (file_btn), "clicked", G_CALLBACK (edit_book_file_select), NULL); */
...
AdapterDSource *
addressbook_edit_book (AddressIndex * addrIndex, AdapterDSource * ads)
{
