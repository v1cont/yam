...
gint
manage_window_focus_in (GtkWidget * widget, GdkEventFocus * event, gpointer data)
{
...
gint
manage_window_focus_out (GtkWidget * widget, GdkEventFocus * event, gpointer data)
{
...
gint
manage_window_unmap (GtkWidget * widget, GdkEventAny * event, gpointer data)
{
...
gint
manage_window_delete (GtkWidget * widget, GdkEventAny * event, gpointer data)
{
...
void
manage_window_destroy (GtkWidget * widget, gpointer data)
{
...
void
manage_window_set_transient (GtkWindow * window)
{
  ...
  if (window && focus_window)
    {
      if (!gtk_window_is_active (GTK_WINDOW (focus_window)))
        yam_window_popup (focus_window);
      gtk_window_set_transient_for (window, GTK_WINDOW (focus_window));
    }
}

void
manage_window_signals_connect (GtkWindow * window)
{
  MANAGE_WINDOW_SIGNALS_CONNECT (window);
}

GtkWidget *
manage_window_get_focus_window (void)
{
  return focus_window;
}
