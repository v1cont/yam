...
*/
void
syldap_set_name (SyldapServer * ldapServer, const gchar * value)
{
...
*/
void
syldap_set_host (SyldapServer * ldapServer, const gchar * value)
{
...
*/
void
syldap_set_port (SyldapServer * ldapServer, const gint value)
{
  addrcache_refresh (ldapServer->addressCache);
  if (value > 0)
    {
...
*/
void
syldap_set_base_dn (SyldapServer * ldapServer, const gchar * value)
{
  addrcache_refresh (ldapServer->addressCache);
...
*/
void
syldap_set_bind_dn (SyldapServer * ldapServer, const gchar * value)
{
  addrcache_refresh (ldapServer->addressCache);
...
*/
void
syldap_set_bind_password (SyldapServer * ldapServer, const gchar * value)
{
  addrcache_refresh (ldapServer->addressCache);
...
*/
void
syldap_set_search_criteria (SyldapServer * ldapServer, const gchar * value)
{
  addrcache_refresh (ldapServer->addressCache);
...
*/
void
syldap_set_search_value (SyldapServer * ldapServer, const gchar * value)
{
  addrcache_refresh (ldapServer->addressCache);
...
*/
void
syldap_set_max_entries (SyldapServer * ldapServer, const gint value)
{
  addrcache_refresh (ldapServer->addressCache);
  if (value > 0)
    {
...
*/
void
syldap_set_timeout (SyldapServer * ldapServer, const gint value)
{
  addrcache_refresh (ldapServer->addressCache);
  if (value > 0)
    {
...
*/
void
syldap_set_callback (SyldapServer * ldapServer, void *func)
{
  ldapServer->callBack = func;
}

void
syldap_set_accessed (SyldapServer * ldapServer, const gboolean value)
{
...
*/
void
syldap_force_refresh (SyldapServer * ldapServer)
{
  addrcache_refresh (ldapServer->addressCache);
  ldapServer->newSearch = TRUE;
}
...
gint
syldap_get_status (SyldapServer * ldapServer)
{
...
ItemFolder *
syldap_get_root_folder (SyldapServer * ldapServer)
{
...
gchar *
syldap_get_name (SyldapServer * ldapServer)
{
  g_return_val_if_fail (ldapServer != NULL, NULL);
...
gboolean
syldap_get_accessed (SyldapServer * ldapServer)
{
...
*/
void
syldap_free (SyldapServer * ldapServer)
{
  g_return_if_fail (ldapServer != NULL);
...
*/
void
syldap_print_data (SyldapServer * ldapServer, FILE * stream)
{
  g_return_if_fail (ldapServer != NULL);
...
*/
void
syldap_print_short (SyldapServer * ldapServer, FILE * stream)
{
  g_return_if_fail (ldapServer != NULL);
...
*/
static void
syldap_build_items_cn (SyldapServer * ldapServer, GSList * listName, GSList * listAddr)
{
  ItemPerson *person;
  ItemEMail *email;
...
*/
static void
syldap_build_items_fl (SyldapServer * ldapServer, GSList * listAddr, GSList * listFirst, GSList * listLast)
{
...
*/
static GSList *
syldap_add_list_values (LDAP * ld, LDAPMessage * entry, char *attr)
{
  GSList *list = NULL;
  gint i;
  gchar **vals;
...
*/
static GSList *
syldap_add_single_value (LDAP * ld, LDAPMessage * entry, char *attr)
{
  GSList *list = NULL;
  gchar **vals;
...
*/
static void
syldap_free_lists (GSList * listName, GSList * listAddr, GSList * listID, GSList * listDN, GSList * listFirst,
                   GSList * listLast)
{
...
*/
gboolean
syldap_check_search (SyldapServer * ldapServer)
{
  g_return_val_if_fail (ldapServer != NULL, FALSE);
...
*/
gint
syldap_search (SyldapServer * ldapServer)
{
  LDAP *ld;
  ...
  for (e = ldap_first_entry (ld, result); e != NULL; e = ldap_next_entry (ld, e))
    {
      entriesFound = TRUE;
      if (ldapServer->entriesRead >= ldapServer->maxEntries)
        break;
      /* printf( "DN: %s\n", ldap_get_dn( ld, e ) ); */
...
static gboolean
syldap_display_search_results (SyldapServer * ldapServer)
{
...
/* ============================================================================================ */
gint
syldap_read_data (SyldapServer * ldapServer)
{
  g_return_val_if_fail (ldapServer != NULL, -1);
...
/* ============================================================================================ */
void
syldap_cancel_read (SyldapServer * ldapServer)
{
  g_return_if_fail (ldapServer != NULL);
...
/* ============================================================================================ */
gint
syldap_read_data_th (SyldapServer * ldapServer)
{
  g_return_val_if_fail (ldapServer != NULL, -1);
...
*/
GList *
syldap_get_list_person (SyldapServer * ldapServer)
{
  g_return_val_if_fail (ldapServer != NULL, NULL);
...
*/
GList *
syldap_get_list_folder (SyldapServer * ldapServer)
{
  g_return_val_if_fail (ldapServer != NULL, NULL);
  return NULL;
}
...
*/
GList *
syldap_read_basedn_s (const gchar * host, const gint port, const gchar * bindDN, const gchar * bindPW, const gint tov)
{
  GList *baseDN = NULL;
  LDAP *ld;
  gint rc, i;
...
*/
GList *
syldap_read_basedn (SyldapServer * ldapServer)
{
  GList *baseDN = NULL;
  LDAP *ld;
  gint rc, i;
  ...
  if (ldapServer->hostName == NULL)
    return baseDN;
  if (ldapServer->port < 1)
    return baseDN;
...
*/
gboolean
syldap_test_connect_s (const gchar * host, const gint port)
{
...
*/
gboolean
syldap_test_connect (SyldapServer * ldapServer)
{
  gboolean retVal = FALSE;
  LDAP *ld;
