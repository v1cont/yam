...
*/
ItemEMail *
addritem_copy_item_email (ItemEMail * item)
{
...
void
addritem_email_set_id (ItemEMail * email, const gchar * value)
{
  ADDRITEM_ID (email) = mgu_replace_string (ADDRITEM_ID (email), value);
}

void
addritem_email_set_alias (ItemEMail * email, const gchar * value)
{
  ADDRITEM_NAME (email) = mgu_replace_string (ADDRITEM_NAME (email), value);
}

void
addritem_email_set_address (ItemEMail * email, const gchar * value)
{
  email->address = mgu_replace_string (email->address, value);
}

void
addritem_email_set_remarks (ItemEMail * email, const gchar * value)
{
...
*/
void
addritem_free_item_email (ItemEMail * item)
{
...
*/
UserAttribute *
addritem_copy_attribute (UserAttribute * item)
{
...
void
addritem_attrib_set_id (UserAttribute * item, const gchar * value)
{
  g_return_if_fail (item != NULL);
...
void
addritem_attrib_set_name (UserAttribute * item, const gchar * value)
{
  g_return_if_fail (item != NULL);
...
void
addritem_attrib_set_value (UserAttribute * item, const gchar * value)
{
  g_return_if_fail (item != NULL);
...
*/
void
addritem_free_attribute (UserAttribute * item)
{
  g_return_if_fail (item != NULL);
  g_free (item->uid);
  g_free (item->name);
...
void
addritem_person_set_id (ItemPerson * person, const gchar * value)
{
  ADDRITEM_ID (person) = mgu_replace_string (ADDRITEM_ID (person), value);
}

void
addritem_person_set_first_name (ItemPerson * person, const gchar * value)
{
  person->firstName = mgu_replace_string (person->firstName, value);
}

void
addritem_person_set_last_name (ItemPerson * person, const gchar * value)
{
  person->lastName = mgu_replace_string (person->lastName, value);
}

void
addritem_person_set_nick_name (ItemPerson * person, const gchar * value)
{
  person->nickName = mgu_replace_string (person->nickName, value);
}

void
addritem_person_set_common_name (ItemPerson * person, const gchar * value)
{
  ADDRITEM_NAME (person) = mgu_replace_string (ADDRITEM_NAME (person), value);
}

void
addritem_person_set_external_id (ItemPerson * person, const gchar * value)
{
  person->externalID = mgu_replace_string (person->externalID, value);
}

void
addritem_person_set_opened (ItemPerson * person, const gboolean value)
{
...
*/
void
addritem_free_list_email (GList * list)
{
  GList *node = list;
  while (node)
    {
...
*/
void
addritem_free_list_attribute (GList * list)
{
  GList *node = list;
  while (node)
    {
...
*/
void
addritem_free_item_person (ItemPerson * person)
{
...
*/
void
addritem_print_item_email (ItemEMail * item, FILE * stream)
{
  g_return_if_fail (item != NULL);
...
*/
void
addritem_print_attribute (UserAttribute * item, FILE * stream)
{
  g_return_if_fail (item != NULL);
...
*/
void
addritem_print_item_person (ItemPerson * person, FILE * stream)
{
  GList *node;
  g_return_if_fail (person != NULL);
...
*/
gboolean
addritem_person_add_email (ItemPerson * person, ItemEMail * email)
{
  GList *node;
...
*/
ItemEMail *
addritem_person_get_email (ItemPerson * person, const gchar * eid)
{
...
*/
ItemEMail *
addritem_person_remove_email_id (ItemPerson * person, const gchar * eid)
{
  ItemEMail *email = NULL;
  GList *node;
...
*/
ItemEMail *
addritem_person_remove_email (ItemPerson * person, ItemEMail * email)
{
...
*/
void
addritem_person_add_attribute (ItemPerson * person, UserAttribute * attrib)
{
  g_return_if_fail (person != NULL);
...
*/
UserAttribute *
addritem_person_get_attribute (ItemPerson * person, const gchar * aid)
{
...
*/
UserAttribute *
addritem_person_remove_attrib_id (ItemPerson * person, const gchar * aid)
{
  UserAttribute *attrib = NULL;
  GList *node;
...
*/
UserAttribute *
addritem_person_remove_attribute (ItemPerson * person, UserAttribute * attrib)
{
  gboolean found = FALSE;
  GList *node;
...
*/
void
addritem_group_set_id (ItemGroup * group, const gchar * value)
{
  ADDRITEM_ID (group) = mgu_replace_string (ADDRITEM_ID (group), value);
}

void
addritem_group_set_name (ItemGroup * group, const gchar * value)
{
  ADDRITEM_NAME (group) = mgu_replace_string (ADDRITEM_NAME (group), value);
}

void
addritem_group_set_remarks (ItemGroup * group, const gchar * value)
{
...
*/
void
addritem_free_item_group (ItemGroup * group)
{
...
*/
gboolean
addritem_group_add_email (ItemGroup * group, ItemEMail * email)
{
  GList *node;
...
*/
ItemEMail *
addritem_group_remove_email (ItemGroup * group, ItemEMail * email)
{
  if (group && email)
    {
...
*/
ItemEMail *
addritem_group_remove_email_id (ItemGroup * group, const gchar * eid)
{
  if (group)
    {
      GList *node = group->listEMail;
...
*/
void
addritem_print_item_group (ItemGroup * group, FILE * stream)
{
  GList *node;
  ItemPerson *person;
  ItemEMail *item;
...
*/
void
addritem_folder_set_id (ItemFolder * folder, const gchar * value)
{
  ADDRITEM_ID (folder) = mgu_replace_string (ADDRITEM_ID (folder), value);
}

void
addritem_folder_set_name (ItemFolder * folder, const gchar * value)
{
  ADDRITEM_NAME (folder) = mgu_replace_string (ADDRITEM_NAME (folder), value);
}

void
addritem_folder_set_remarks (ItemFolder * folder, const gchar * value)
{
...
*/
void
addritem_free_item_folder (ItemFolder * folder)
{
...
*/
void
addritem_free_item_folder_recurse (ItemFolder * parent)
{
...
*/
void
addritem_folder_free_person (ItemFolder * folder)
{
  GList *node;
...
*/
gboolean
addritem_folder_add_person (ItemFolder * folder, ItemPerson * item)
{
...
*/
gboolean
addritem_folder_add_folder (ItemFolder * folder, ItemFolder * item)
{
  g_return_val_if_fail (folder != NULL, FALSE);
  g_return_val_if_fail (item != NULL, FALSE);
...
*/
gboolean
addritem_folder_add_group (ItemFolder * folder, ItemGroup * item)
{
  g_return_val_if_fail (folder != NULL, FALSE);
  g_return_val_if_fail (item != NULL, FALSE);
...
*/
void
addritem_print_item_folder (ItemFolder * folder, FILE * stream)
{
  GList *node;
  /* ItemPerson *person; */
  ItemFolder *parent;
...
*/
GList *
addritem_folder_get_person_list (ItemFolder * folder)
{
  GList *list = NULL;
  GList *node = NULL;
...
*/
GList *
addritem_folder_get_group_list (ItemFolder * folder)
{
  GList *list = NULL;
  GList *node = NULL;
...
ItemEMail *
addritem_move_email_before (ItemPerson * person, ItemEMail * itemMove, ItemEMail * itemTarget)
{
  gint posT, posM;
...
*/
ItemEMail *
addritem_move_email_after (ItemPerson * person, ItemEMail * itemMove, ItemEMail * itemTarget)
{
  gint posT, posM;
