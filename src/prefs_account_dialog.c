...
static void prefs_account_protocol_activated (GtkComboBox *combo, gpointer data);
...
static PrefsUIData ui_data[] = {
  /* Basic */
  {"account_name", &basic.acname_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"is_default", &basic.default_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"name", &basic.name_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"address", &basic.addr_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"organization", &basic.org_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"protocol", &basic.protocol_optmenu, prefs_account_protocol_set_data_from_optmenu, prefs_account_protocol_set_optmenu},
  {"receive_server", &basic.recvserv_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"smtp_server", &basic.smtpserv_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"nntp_server", &basic.nntpserv_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"use_nntp_auth", &basic.nntpauth_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"user_id", &basic.uid_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"password", &basic.pass_entry, prefs_set_data_from_entry, prefs_set_entry},

  /* Receive */
  {"use_apop_auth", &receive.use_apop_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"remove_mail", &receive.rmmail_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"message_leave_time", &receive.leave_time_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"get_all_mail", &receive.getall_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"enable_size_limit", &receive.size_limit_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"size_limit", &receive.size_limit_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"filter_on_receive", &receive.filter_on_recv_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"inbox", &receive.inbox_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"imap_check_inbox_only", &receive.imap_check_inbox_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"imap_filter_inbox_on_receive", &receive.imap_filter_inbox_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"imap_auth_method", &receive.imap_auth_type_optmenu, prefs_account_imap_auth_type_set_data_from_optmenu,
   prefs_account_imap_auth_type_set_optmenu},
  {"max_nntp_articles", &receive.maxarticle_spinbtn, prefs_set_data_from_spinbtn, prefs_set_spinbtn},
  {"receive_at_get_all", &receive.recvatgetall_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},

  /* Send */
  {"add_date", &p_send.date_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"generate_msgid", &p_send.msgid_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"add_custom_header", &p_send.customhdr_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"use_smtp_auth", &p_send.smtp_auth_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"smtp_auth_method", &p_send.smtp_auth_type_optmenu, prefs_account_smtp_auth_type_set_data_from_optmenu,
   prefs_account_smtp_auth_type_set_optmenu},
  {"smtp_user_id", &p_send.smtp_uid_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"smtp_password", &p_send.smtp_pass_entry, prefs_set_data_from_entry, prefs_set_entry},

  {"pop_before_smtp", &p_send.pop_bfr_smtp_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},

  /* Compose */
  {"signature_type", &compose.sig_radiobtn, prefs_account_enum_set_data_from_radiobtn, prefs_account_enum_set_radiobtn},
  {"signature_path", &compose.sigpath_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"signature_before_quote", &compose.sig_before_quote_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"set_autocc", &compose.autocc_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"auto_cc", &compose.autocc_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"set_autobcc", &compose.autobcc_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"auto_bcc", &compose.autobcc_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"set_autoreplyto", &compose.autoreplyto_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"auto_replyto", &compose.autoreplyto_entry, prefs_set_data_from_entry, prefs_set_entry},

#if USE_GPGME
  /* Privacy */
  {"default_sign", &privacy.default_sign_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"default_encrypt", &privacy.default_encrypt_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"encrypt_reply", &privacy.encrypt_reply_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"encrypt_to_self", &privacy.encrypt_to_self_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"ascii_armored", &privacy.ascii_armored_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"clearsign", &privacy.clearsign_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"sign_key", &privacy.defaultkey_radiobtn, prefs_account_enum_set_data_from_radiobtn, prefs_account_enum_set_radiobtn},
  {"sign_key_id", &privacy.customkey_entry, prefs_set_data_from_entry, prefs_set_entry},
#endif /* USE_GPGME */

#if USE_SSL
  /* SSL */
  {"ssl_pop", &ssl.pop_nossl_radiobtn, prefs_account_enum_set_data_from_radiobtn, prefs_account_enum_set_radiobtn},
  {"ssl_imap", &ssl.imap_nossl_radiobtn, prefs_account_enum_set_data_from_radiobtn, prefs_account_enum_set_radiobtn},
  {"ssl_nntp", &ssl.nntp_nossl_radiobtn, prefs_account_enum_set_data_from_radiobtn, prefs_account_enum_set_radiobtn},
  {"ssl_smtp", &ssl.smtp_nossl_radiobtn, prefs_account_enum_set_data_from_radiobtn, prefs_account_enum_set_radiobtn},
  {"use_nonblocking_ssl", &ssl.use_nonblocking_ssl_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
#endif /* USE_SSL */

  /* Proxy */
  {"use_socks", &p_proxy.socks_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"socks_type", &p_proxy.socks4_radiobtn, prefs_account_enum_set_data_from_radiobtn, prefs_account_enum_set_radiobtn},
  {"proxy_host", &p_proxy.socks_host_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"proxy_port", &p_proxy.socks_port_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"use_proxy_auth", &p_proxy.socks_auth_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"proxy_name", &p_proxy.socks_name_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"proxy_pass", &p_proxy.socks_pass_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"use_socks_for_send", &p_proxy.socks_send_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},

  /* Advanced */
  {"set_smtpport", &advanced.smtpport_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"smtp_port", &advanced.smtpport_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"set_popport", &advanced.popport_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"pop_port", &advanced.popport_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"set_imapport", &advanced.imapport_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"imap_port", &advanced.imapport_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"set_nntpport", &advanced.nntpport_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"nntp_port", &advanced.nntpport_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"set_domain", &advanced.domain_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"domain", &advanced.domain_entry, prefs_set_data_from_entry, prefs_set_entry},

  {"imap_directory", &advanced.imapdir_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"imap_clear_cache_on_exit", &advanced.clear_cache_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},

  {"set_sent_folder", &advanced.sent_folder_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"sent_folder", &advanced.sent_folder_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"set_draft_folder", &advanced.draft_folder_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"draft_folder", &advanced.draft_folder_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"set_queue_folder", &advanced.queue_folder_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"queue_folder", &advanced.queue_folder_entry, prefs_set_data_from_entry, prefs_set_entry},
  {"set_trash_folder", &advanced.trash_folder_chkbtn, prefs_set_data_from_toggle, prefs_set_toggle},
  {"trash_folder", &advanced.trash_folder_entry, prefs_set_data_from_entry, prefs_set_entry},
...
static void prefs_account_name_entry_changed_cb (GtkWidget * widget, gpointer data);
...
static gint prefs_account_deleted (GtkWidget * widget, GdkEventAny * event, gpointer data);
static gboolean prefs_account_key_pressed (GtkWidget * widget, GdkEventKey * event, gpointer data);
static void prefs_account_ok (void);
static gint prefs_account_apply (void);
static void prefs_account_cancel (void);

PrefsAccount *
prefs_account_open (PrefsAccount * ac_prefs)
{
  ...
  if (new_account)
    {
      ...
      g_signal_handlers_block_by_func (G_OBJECT (compose.sig_buffer), G_CALLBACK (prefs_account_sig_changed_cb), NULL);
      ...
      if (def_ac)
        {
          gtk_entry_set_text (GTK_ENTRY (basic.name_entry), def_ac->name ? def_ac->name : "");
          gtk_entry_set_text (GTK_ENTRY (basic.addr_entry), def_ac->address ? def_ac->address : "");
          gtk_entry_set_text (GTK_ENTRY (basic.org_entry), def_ac->organization ? def_ac->organization : "");
        }
      gtk_widget_set_sensitive (basic.protocol_optmenu, TRUE);

      gtk_combo_box_set_active (GTK_COMBO_BOX (compose.sig_combo), 0);

      gtk_window_set_title (GTK_WINDOW (dialog.window), _("Preferences for new account"));
      gtk_widget_hide (dialog.apply_btn);

      g_signal_handlers_unblock_by_func
        (G_OBJECT (compose.sig_buffer), G_CALLBACK (prefs_account_sig_changed_cb), NULL);
    }
  else
    {
      gint i;
      ...
      gtk_combo_box_set_active (GTK_COMBO_BOX (compose.sig_combo), 0);
      gtk_entry_set_text (GTK_ENTRY (compose.signame_entry), compose.sig_names[0] ? compose.sig_names[0] : "");
      prefs_set_escaped_str_to_text (compose.sig_text, compose.sig_texts[0]);

      prefs_set_dialog (prefs_account_get_params ());
      gtk_window_set_title (GTK_WINDOW (dialog.window), _("Account preferences"));
      gtk_widget_show (dialog.apply_btn);
    }

  gtk_widget_show (dialog.window);
  yam_plugin_signal_emit ("prefs-account-open", new_account ? NULL : ac_prefs, dialog.window);
...
prefs_account_create (void)
{
  ...
  g_signal_connect (G_OBJECT (dialog.window), "delete_event", G_CALLBACK (prefs_account_deleted), NULL);
  g_signal_connect (G_OBJECT (dialog.window), "key_press_event", G_CALLBACK (prefs_account_key_pressed), NULL);
  MANAGE_WINDOW_SIGNALS_CONNECT (dialog.window);

  g_signal_connect (G_OBJECT (dialog.ok_btn), "clicked", G_CALLBACK (prefs_account_ok), NULL);
  g_signal_connect (G_OBJECT (dialog.apply_btn), "clicked", G_CALLBACK (prefs_account_apply), NULL);
  g_signal_connect (G_OBJECT (dialog.cancel_btn), "clicked", G_CALLBACK (prefs_account_cancel), NULL);
  ...
  g_signal_connect (G_OBJECT (basic.name_entry), "changed", G_CALLBACK (prefs_account_name_entry_changed_cb), NULL);
  g_signal_connect (G_OBJECT (basic.addr_entry), "changed", G_CALLBACK (prefs_account_name_entry_changed_cb), NULL);
  g_signal_connect (G_OBJECT (compose.sig_buffer), "changed", G_CALLBACK (prefs_account_sig_changed_cb), NULL);
}

static void
prefs_account_basic_create (void)
{
  GtkWidget *vbox1;
  GtkWidget *hbox;
  GtkWidget *label;
  ...
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), _("POP3"));
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), _("IMAP4"));
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), _("News (NNTP)"));
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), _("None (local)"));

  g_signal_connect (G_OBJECT (optmenu), "changed", G_CALLBACK (prefs_account_protocol_activated), NULL);
  ...
  gtk_grid_set_column_spacing (GTK_GRID (serv_table), 5);

  nntpauth_chkbtn = gtk_check_button_new_with_label (_("This server requires authentication"));
  gtk_grid_attach (GTK_GRID (serv_table), nntpauth_chkbtn, 0, 0, 1, 2);

  nntpserv_label = gtk_label_new (_("News server"));
  gtk_grid_attach (GTK_GRID (serv_table), nntpserv_label, 0, 1, 1, 1);
  gtk_label_set_xalign (GTK_LABEL (nntpserv_label), 1.0);

  nntpserv_entry = gtk_entry_new ();
  gtk_widget_set_hexpand (nntpserv_entry, TRUE);
  gtk_grid_attach (GTK_GRID (serv_table), nntpserv_entry, 1, 1, 1, 1);
  ...
  gtk_grid_attach (GTK_GRID (serv_table), recvserv_entry, 1, 2, 1, 1);

  smtpserv_label = gtk_label_new (_("SMTP server (send)"));
  gtk_grid_attach (GTK_GRID (serv_table), smtpserv_label, 0, 3, 1, 1);
  gtk_label_set_xalign (GTK_LABEL (smtpserv_label), 1.0);

  smtpserv_entry = gtk_entry_new ();
  gtk_widget_set_hexpand (smtpserv_entry, TRUE);
  gtk_grid_attach (GTK_GRID (serv_table), smtpserv_entry, 1, 3, 1, 1);

  uid_label = gtk_label_new (_("User ID"));
  gtk_grid_attach (GTK_GRID (serv_table), uid_label, 0, 4, 1, 1);
  ...
  gtk_grid_attach (GTK_GRID (serv_table), uid_entry, 1, 4, 1, 1);

  pass_label = gtk_label_new (_("Password"));
  gtk_grid_attach (GTK_GRID (serv_table), pass_label, 0, 5, 1, 1);

  pass_entry = gtk_entry_new ();
  gtk_widget_set_hexpand (pass_entry, TRUE);
  gtk_widget_set_size_request (pass_entry, DEFAULT_ENTRY_WIDTH, -1);
  gtk_grid_attach (GTK_GRID (serv_table), pass_entry, 1, 5, 1, 1);
...
static void
prefs_account_receive_create (void)
{
  GtkWidget *vbox1;
  GtkWidget *frame1;
  GtkWidget *vbox2;
  ...
  PACK_CHECK_BUTTON (vbox2, use_apop_chkbtn, _("Use secure authentication (APOP)"));

  PACK_CHECK_BUTTON (vbox2, rmmail_chkbtn, _("Remove messages on server when received"));
  ...
  leave_time_label = yam_label_note (_("0 days: remove immediately"));
  gtk_widget_show (leave_time_label);
  gtk_box_pack_start (GTK_BOX (hbox1), leave_time_label, FALSE, FALSE, 0);
  ...
  PACK_CHECK_BUTTON (vbox2, getall_chkbtn, _("Download all messages (including already received) on server"));
  ...
  PACK_CHECK_BUTTON (vbox2, filter_on_recv_chkbtn, _("Filter messages on receiving"));
  ...
  PACK_SMALL_LABEL (vbox2, label, _("Unfiltered messages will be stored in this folder."));
  ...
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), _("Automatic"));
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), "LOGIN");
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), "PLAIN");
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), "CRAM-MD5");

  PACK_CHECK_BUTTON (vbox2, imap_check_inbox_chkbtn, _("Only check INBOX on receiving"));
  PACK_CHECK_BUTTON (vbox2, imap_filter_inbox_chkbtn, _("Filter new messages in INBOX on receiving"));
  ...
  maxarticle_spinbtn_adj = gtk_adjustment_new (300, 0, 10000, 10, 100, 0);
  maxarticle_spinbtn = gtk_spin_button_new (GTK_ADJUSTMENT (maxarticle_spinbtn_adj), 10, 0);
  gtk_widget_show (maxarticle_spinbtn);
  gtk_box_pack_start (GTK_BOX (hbox1), maxarticle_spinbtn, FALSE, FALSE, 0);
  gtk_widget_set_size_request (maxarticle_spinbtn, 64, -1);
  gtk_spin_button_set_numeric (GTK_SPIN_BUTTON (maxarticle_spinbtn), TRUE);

  PACK_SMALL_LABEL (vbox2, maxarticle_desc_label, _("No limit if 0 is specified."));

  PACK_CHECK_BUTTON (vbox1, recvatgetall_chkbtn, _("`Get all' checks for new messages on this account"));
...
static void
prefs_account_send_create (void)
{
  GtkWidget *vbox1;
  GtkWidget *vbox2;
  GtkWidget *frame;
  ...
  PACK_CHECK_BUTTON (hbox, customhdr_chkbtn, _("Add user-defined header"));
  ...
  PACK_CHECK_BUTTON (vbox3, smtp_auth_chkbtn, _("SMTP Authentication (SMTP AUTH)"));
  ...
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), "LOGIN");
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), "CRAM-MD5");
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (optmenu), "DIGEST-MD5");
  ...
  label = yam_label_note
    (_("If you leave these entries empty, the same user ID and password as receiving will be used."));
  gtk_widget_show (label);
  gtk_box_pack_start (GTK_BOX (hbox), label, FALSE, FALSE, 0);
  ...
  PACK_CHECK_BUTTON (vbox3, pop_bfr_smtp_chkbtn, _("Authenticate with POP3 before sending"));
...
static void
prefs_account_compose_create (void)
{
  GtkWidget *vbox1;
  GtkWidget *sig_vbox;
  GtkWidget *sig_radiobtn;
  ...
  PACK_FRAME_EXP (vbox1, frame, _("Signature"));

  sig_vbox = gtk_box_new (GTK_ORIENTATION_VERTICAL, VSPACING_NARROW_2);
  gtk_container_add (GTK_CONTAINER (frame), sig_vbox);
  gtk_container_set_border_width (GTK_CONTAINER (sig_vbox), 8);

  sig_radiobtn = gtk_radio_button_new_with_label (NULL, _("Direct input"));
  gtk_box_pack_start (GTK_BOX (sig_vbox), sig_radiobtn, FALSE, FALSE, 0);
  g_object_set_data (G_OBJECT (sig_radiobtn), MENU_VAL_ID, GINT_TO_POINTER (SIG_DIRECT));

  sig_hbox = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 8);
  gtk_box_pack_start (GTK_BOX (sig_vbox), sig_hbox, FALSE, FALSE, 0);

  sig_combo = gtk_combo_box_text_new ();
  ...
  for (i = 0; i < 10; i++)
    {
      ...
      gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (sig_combo), buf);
    }
  gtk_combo_box_set_active (GTK_COMBO_BOX (sig_combo), 0);
  g_signal_connect (GTK_COMBO_BOX (sig_combo), "changed", G_CALLBACK (prefs_account_sig_combo_changed_cb), NULL);
  ...
  sigtext_label = yam_label_note (_("'Signature 1' will be used by default."));
  ...
  gtk_scrolled_window_set_policy (GTK_SCROLLED_WINDOW (sigtext_scrwin), GTK_POLICY_NEVER, GTK_POLICY_ALWAYS);
  gtk_scrolled_window_set_shadow_type (GTK_SCROLLED_WINDOW (sigtext_scrwin), GTK_SHADOW_IN);
  ...
  sigfile_radiobtn = gtk_radio_button_new_with_label_from_widget (GTK_RADIO_BUTTON (sig_radiobtn), _("File"));
  ...
  sigcmd_radiobtn = gtk_radio_button_new_with_label_from_widget (GTK_RADIO_BUTTON (sig_radiobtn), _("Command output"));
  ...
  gtk_box_pack_start (GTK_BOX (sig_vbox), sigpath_entry, FALSE, TRUE, 0);

  PACK_CHECK_BUTTON (sig_vbox, sig_before_quote_chkbtn, _("Put signature before quote (not recommended)"));
  ...
  gtk_grid_attach (GTK_GRID (table), autocc_chkbtn, 0, 0, 1, 1);
  ...
  gtk_grid_attach (GTK_GRID (table), autobcc_chkbtn, 0, 1, 1, 1);
  ...
  gtk_grid_attach (GTK_GRID (table), autoreplyto_chkbtn, 0, 2, 1, 1);
...
#if USE_GPGME
static void
prefs_account_privacy_create (void)
{
  GtkWidget *vbox1;
  GtkWidget *frame1;
  GtkWidget *vbox2;
  ...
  PACK_CHECK_BUTTON (vbox2, default_sign_chkbtn, _("PGP sign message by default"));
  PACK_CHECK_BUTTON (vbox2, default_encrypt_chkbtn, _("PGP encrypt message by default"));
  PACK_CHECK_BUTTON (vbox2, encrypt_reply_chkbtn, _("Encrypt when replying to encrypted message"));
  PACK_CHECK_BUTTON (vbox2, encrypt_to_self_chkbtn, _("Add my own key to the recipients list on encryption"));
  PACK_CHECK_BUTTON (vbox2, ascii_armored_chkbtn, _("Use ASCII-armored format for encryption"));
  PACK_CHECK_BUTTON (vbox2, clearsign_chkbtn, _("Use clear text signature"));
  g_signal_connect (G_OBJECT (ascii_armored_chkbtn), "toggled", G_CALLBACK (prefs_account_ascii_armored_warning), NULL);
  ...
  defaultkey_radiobtn = gtk_radio_button_new_with_label (NULL, _("Use default GnuPG key"));
  gtk_widget_show (defaultkey_radiobtn);
  gtk_box_pack_start (GTK_BOX (vbox2), defaultkey_radiobtn, FALSE, FALSE, 0);
  ...
  emailkey_radiobtn = gtk_radio_button_new_with_label_from_widget
    (GTK_RADIO_BUTTON (defaultkey_radiobtn), _("Select key by your email address"));
  gtk_widget_show (emailkey_radiobtn);
  gtk_box_pack_start (GTK_BOX (vbox2), emailkey_radiobtn, FALSE, FALSE, 0);
  g_object_set_data (G_OBJECT (emailkey_radiobtn), MENU_VAL_ID, GINT_TO_POINTER (SIGN_KEY_BY_FROM));

  customkey_radiobtn = gtk_radio_button_new_with_label_from_widget
    (GTK_RADIO_BUTTON (defaultkey_radiobtn), _("Specify key manually"));
  gtk_widget_show (customkey_radiobtn);
  gtk_box_pack_start (GTK_BOX (vbox2), customkey_radiobtn, FALSE, FALSE, 0);
  g_object_set_data (G_OBJECT (customkey_radiobtn), MENU_VAL_ID, GINT_TO_POINTER (SIGN_KEY_CUSTOM));
  ...
  gtk_box_pack_start (GTK_BOX (hbox1), customkey_entry, TRUE, TRUE, 0);
...
#if USE_SSL
static void
pop_ssltunnel_toggled (GtkToggleButton * button, gpointer data)
{
  if (gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (advanced.popport_chkbtn)))
    return;
...
static void
imap_ssltunnel_toggled (GtkToggleButton * button, gpointer data)
{
  if (gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (advanced.imapport_chkbtn)))
    return;
...
static void
nntp_ssltunnel_toggled (GtkToggleButton * button, gpointer data)
{
  if (gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (advanced.nntpport_chkbtn)))
    return;
...
static void
smtp_ssltunnel_toggled (GtkToggleButton * button, gpointer data)
{
  if (gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (advanced.smtpport_chkbtn)))
    return;
...
prefs_account_ssl_create (void)
{
  ...
  CREATE_RADIO_BUTTONS (vbox2,
                        ...
                        SSL_TUNNEL,
                        pop_starttls_radiobtn, _("Use STARTTLS command to start SSL session"), SSL_STARTTLS);
  ...
  CREATE_RADIO_BUTTONS (vbox3,
                        ...
                        SSL_TUNNEL,
                        imap_starttls_radiobtn, _("Use STARTTLS command to start SSL session"), SSL_STARTTLS);
  ...
  nntp_nossl_radiobtn = gtk_radio_button_new_with_label (NULL, _("Don't use SSL"));
  ...
  CREATE_RADIO_BUTTONS (vbox5,
                        ...
                        SSL_TUNNEL,
                        smtp_starttls_radiobtn, _("Use STARTTLS command to start SSL session"), SSL_STARTTLS);
  ...
  PACK_CHECK_BUTTON (vbox6, use_nonblocking_ssl_chkbtn, _("Use non-blocking SSL"));
  PACK_SMALL_LABEL (vbox6, label, _("Turn this off if you have problems in SSL connection."));
...
static void
prefs_account_proxy_create (void)
{
  GtkWidget *vbox1;
  GtkWidget *vbox2;
  ...
  PACK_FRAME_WITH_CHECK_BUTTON (vbox1, socks_frame, socks_chkbtn, _("Use SOCKS proxy"));
  ...
  g_object_set_data (G_OBJECT (socks4_radiobtn), MENU_VAL_ID, GINT_TO_POINTER (SOCKS_SOCKS4));

  CREATE_RADIO_BUTTON (hbox2, socks5_radiobtn, socks4_radiobtn, "SOCKS5", SOCKS_SOCKS5);
  ...
  PACK_CHECK_BUTTON (vbox2, socks_send_chkbtn, _("Use SOCKS proxy on sending"));
...
static void
prefs_account_advanced_create (void)
{
  GtkWidget *vbox1;
  GtkWidget *vbox2;
  GtkWidget *hbox1;
...
#define PACK_PORT_ENTRY(box, entry)                             \
  ...
  PACK_CHECK_BUTTON (hbox_popport, checkbtn_popport, _("Specify POP3 port"));
  PACK_PORT_ENTRY (hbox_popport, entry_popport);
  SET_TOGGLE_SENSITIVITY (checkbtn_popport, entry_popport);

  PACK_HBOX (hbox_imapport);
  PACK_CHECK_BUTTON (hbox_imapport, checkbtn_imapport, _("Specify IMAP4 port"));
  ...
  PACK_CHECK_BUTTON (hbox_nntpport, checkbtn_nntpport, _("Specify NNTP port"));
...
#undef PACK_PORT_ENTRY
  ...
  PACK_SMALL_LABEL (vbox3, desc_label, _("Only the subfolders of this directory will be displayed."));

  PACK_CHECK_BUTTON (vbox3, clear_cache_chkbtn, _("Clear all message caches on exit"));
...
#define SET_CHECK_BTN_AND_ENTRY(label, chkbtn, entry, n)                \
  {                                                                     \
	...
	gtk_grid_attach (GTK_GRID (table), chkbtn, 0, n, 1, 1);             \
                                                                        \
	entry = gtk_entry_new ();                                           \
	...
	g_signal_connect (G_OBJECT (button), "clicked",                     \
                      G_CALLBACK (prefs_account_select_folder_cb), entry); \
                                                                        \
	SET_TOGGLE_SENSITIVITY (chkbtn, entry);                             \
	SET_TOGGLE_SENSITIVITY (chkbtn, button);                            \
  }

  SET_CHECK_BTN_AND_ENTRY (_("Put sent messages in"), sent_folder_chkbtn, sent_folder_entry, 0);
  SET_CHECK_BTN_AND_ENTRY (_("Put draft messages in"), draft_folder_chkbtn, draft_folder_entry, 1);
  SET_CHECK_BTN_AND_ENTRY (_("Put queued messages in"), queue_folder_chkbtn, queue_folder_entry, 2);
  SET_CHECK_BTN_AND_ENTRY (_("Put deleted messages in"), trash_folder_chkbtn, trash_folder_entry, 3);
...
static gint
prefs_account_deleted (GtkWidget * widget, GdkEventAny * event, gpointer data)
{
...
static gboolean
prefs_account_key_pressed (GtkWidget * widget, GdkEventKey * event, gpointer data)
{
...
static gint
prefs_account_apply (void)
{
  RecvProtocol protocol;
  PrefsAccount *tmp_ac_prefs;
  gint i;

  protocol = gtk_combo_box_get_active (GTK_COMBO_BOX (basic.protocol_optmenu));

  yam_entry_strip_text (GTK_ENTRY (basic.addr_entry));
  yam_entry_strip_text (GTK_ENTRY (basic.smtpserv_entry));
  yam_entry_strip_text (GTK_ENTRY (basic.recvserv_entry));
  yam_entry_strip_text (GTK_ENTRY (basic.nntpserv_entry));
  ...
  if ((protocol == A_POP3 || protocol == A_LOCAL) && *gtk_entry_get_text (GTK_ENTRY (basic.smtpserv_entry)) == '\0')
    {
      alertpanel_error (_("SMTP server is not entered."));
      return -1;
    }
  if ((protocol == A_POP3 || protocol == A_IMAP4) && *gtk_entry_get_text (GTK_ENTRY (basic.uid_entry)) == '\0')
    {
      alertpanel_error (_("User ID is not entered."));
      return -1;
    }
  if (protocol == A_POP3 && *gtk_entry_get_text (GTK_ENTRY (basic.recvserv_entry)) == '\0')
    {
      alertpanel_error (_("POP3 server is not entered."));
      return -1;
    }
  if (protocol == A_IMAP4 && *gtk_entry_get_text (GTK_ENTRY (basic.recvserv_entry)) == '\0')
    {
      alertpanel_error (_("IMAP4 server is not entered."));
      return -1;
    }
  if (protocol == A_NNTP && *gtk_entry_get_text (GTK_ENTRY (basic.nntpserv_entry)) == '\0')
    {
...
static void
prefs_account_select_folder_cb (GtkWidget * widget, gpointer data)
{
  FolderItem *item;
  gchar *id;
  ...
  if (item && item->path)
    {
      ...
      if (entry == GTK_ENTRY (advanced.queue_folder_entry) && item->stype != F_QUEUE)
        {
          alertpanel_error (_("Specified folder is not a queue folder."));
          return;
        }
...
static void
prefs_account_edit_custom_header (void)
{
  prefs_custom_header_open (prefs_account_get_tmp_prefs ());
}

static void
prefs_account_name_entry_changed_cb (GtkWidget * widget, gpointer data)
{
  if (new_account && !compose.sig_modified)
    {
      ...
      sig = g_strdup_printf
        ("%s <%s>\n",
         gtk_entry_get_text (GTK_ENTRY (basic.name_entry)), gtk_entry_get_text (GTK_ENTRY (basic.addr_entry)));
...
static void
prefs_account_sig_changed_cb (GtkWidget * widget, gpointer data)
{
  compose.sig_modified = TRUE;
}

static void
prefs_account_sig_combo_changed_cb (GtkWidget * widget, gpointer data)
{
  gint cur_page;
  gint new_page;
  ...
  compose.sig_names[cur_page] = gtk_editable_get_chars (GTK_EDITABLE (compose.signame_entry), 0, -1);
  g_free (compose.sig_texts[cur_page]);
  compose.sig_texts[cur_page] = prefs_get_escaped_str_from_text (compose.sig_text);
  ...
  if (cur_page != new_page)
    {
      ...
      prefs_set_escaped_str_to_text (compose.sig_text, compose.sig_texts[new_page]);
      compose.sig_selected = new_page;
    }
}

static void
prefs_account_enum_set_data_from_radiobtn (PrefParam * pparam)
{
  PrefsUIData *ui_data;
...
static void
prefs_account_enum_set_radiobtn (PrefParam * pparam)
{
  PrefsUIData *ui_data;
  GtkRadioButton *radiobtn;
  GSList *group;
...
#if USE_GPGME
static void
prefs_account_ascii_armored_warning (GtkWidget * widget)
{
...
static void
prefs_account_protocol_set_data_from_optmenu (PrefParam * pparam)
{
  PrefsUIData *ui_data = (PrefsUIData *) pparam->ui_data;
  g_return_if_fail (ui_data != NULL);
  g_return_if_fail (*ui_data->widget != NULL);

  *((RecvProtocol *) pparam->data) = gtk_combo_box_get_active (GTK_COMBO_BOX (*ui_data->widget));
}

static void
prefs_account_protocol_set_optmenu (PrefParam * pparam)
{
  PrefsUIData *ui_data;
  RecvProtocol protocol;
  GtkComboBox *optmenu;
  ...
  gtk_combo_box_set_active (optmenu, protocol);
}

static void
prefs_account_imap_auth_type_set_data_from_optmenu (PrefParam * pparam)
{
  gint val;
  PrefsUIData *ui_data = (PrefsUIData *) pparam->ui_data;
  ...
  val = gtk_combo_box_get_active (GTK_COMBO_BOX (*ui_data->widget));

  if (val > 0)
    *((RecvProtocol *) pparam->data) = 1 << (val - 1);
  else
    *((RecvProtocol *) pparam->data) = 0;
}

static void
prefs_account_imap_auth_type_set_optmenu (PrefParam * pparam)
{
  PrefsUIData *ui_data;
  ...
  switch (type)
    ...
    case IMAP_AUTH_LOGIN:
      gtk_combo_box_set_active (optmenu, 1);
      break;
    case IMAP_AUTH_PLAIN:
      gtk_combo_box_set_active (optmenu, 2);
      break;
    case IMAP_AUTH_CRAM_MD5:
      gtk_combo_box_set_active (optmenu, 3);
      break;
    case 0:
    default:
...
static void
prefs_account_smtp_auth_type_set_data_from_optmenu (PrefParam * pparam)
{
  gint val;
  PrefsUIData *ui_data = (PrefsUIData *) pparam->ui_data;
...
static void
prefs_account_smtp_auth_type_set_optmenu (PrefParam * pparam)
{
  PrefsUIData *ui_data;
  ...
  switch (type)
    ...
    case SMTPAUTH_DIGEST_MD5:
      gtk_combo_box_set_active (optmenu, 4);
      break;
    case 0:
    default:
      gtk_combo_box_set_active (optmenu, 0);
...
static void
prefs_account_protocol_activated (GtkComboBox *combo, gpointer data)
{
  RecvProtocol protocol;
  gboolean active;

  protocol = (RecvProtocol) gtk_combo_box_get_active (combo);
  ...
  switch (protocol)
    ...
    case A_NNTP:
      ...
      active = gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (basic.nntpauth_chkbtn));
      ...
      if (new_account)
        gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (receive.recvatgetall_chkbtn), FALSE);
    ...
    case A_LOCAL:
      ...
      if (new_account)
        gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (receive.recvatgetall_chkbtn), TRUE);
