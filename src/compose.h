...
Compose *compose_new (PrefsAccount * account, FolderItem * item, const gchar * mailto, GPtrArray * attach_files);

Compose *compose_reply (MsgInfo * msginfo, FolderItem * item, ComposeMode mode, const gchar * body);
Compose *compose_forward (GSList * mlist, FolderItem * item, gboolean as_attach, const gchar * body);
Compose *compose_redirect (MsgInfo * msginfo, FolderItem * item);
Compose *compose_reedit (MsgInfo * msginfo);

GList *compose_get_compose_list (void);

void compose_entry_set (Compose * compose, const gchar * text, ComposeEntryType type);
void compose_entry_append (Compose * compose, const gchar * text, ComposeEntryType type);
...
void compose_attach_append (Compose * compose, const gchar * file, const gchar * filename, const gchar * content_type);
