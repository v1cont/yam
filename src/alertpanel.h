...
AlertValue alertpanel_full (const gchar * title, const gchar * message, AlertType type,
                            AlertValue default_value, gboolean can_disable,
...
void alertpanel_message (const gchar * title, const gchar * message, AlertType type);

AlertValue alertpanel_message_with_disable (const gchar * title, const gchar * message, AlertType type);
