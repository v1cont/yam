...
gboolean summary_show (SummaryView * summaryview, FolderItem * fitem, gboolean update_cache);
...
GSList *summary_get_flagged_msg_list (SummaryView * summaryview, MsgPermFlags flags);
...
void summary_select_row (SummaryView * summaryview, GtkTreeIter * iter, gboolean display_msg, gboolean do_refresh);
...
void summary_display_msg_selected (SummaryView * summaryview, gboolean new_window, gboolean all_headers);
