...
*/
void
addrbook_set_name (AddressBookFile * book, const gchar * value)
{
...
void
addrbook_set_path (AddressBookFile * book, const gchar * value)
{
  g_return_if_fail (book != NULL);
...
void
addrbook_set_file (AddressBookFile * book, const gchar * value)
{
  g_return_if_fail (book != NULL);
...
void
addrbook_set_accessed (AddressBookFile * book, const gboolean value)
{
  g_return_if_fail (book != NULL);
...
gboolean
addrbook_get_modified (AddressBookFile * book)
{
...
gboolean
addrbook_get_accessed (AddressBookFile * book)
{
  g_return_val_if_fail (book != NULL, FALSE);
...
gboolean
addrbook_get_read_flag (AddressBookFile * book)
{
  g_return_val_if_fail (book != NULL, FALSE);
...
gint
addrbook_get_status (AddressBookFile * book)
{
...
ItemFolder *
addrbook_get_root_folder (AddressBookFile * book)
{
...
GList *
addrbook_get_list_folder (AddressBookFile * book)
{
  g_return_val_if_fail (book != NULL, NULL);
...
GList *
addrbook_get_list_person (AddressBookFile * book)
{
  g_return_val_if_fail (book != NULL, NULL);
...
gchar *
addrbook_get_name (AddressBookFile * book)
{
  g_return_val_if_fail (book != NULL, NULL);
  return book->name;
}
...
*/
void
addrbook_empty_book (AddressBookFile * book)
{
  g_return_if_fail (book != NULL);
...
*/
void
addrbook_free_book (AddressBookFile * book)
{
  g_return_if_fail (book != NULL);
...
*/
void
addrbook_print_item_list (GList * list, FILE * stream)
{
  GList *node = list;
...
*/
void
addrbook_print_book (AddressBookFile * book, FILE * stream)
{
  g_return_if_fail (book != NULL);
...
*/
void
addrbook_dump_book (AddressBookFile * book, FILE * stream)
{
  ItemFolder *folder;
...
*/
ItemGroup *
addrbook_remove_group (AddressBookFile * book, ItemGroup * group)
{
  ItemGroup *item;
...
*/
ItemPerson *
addrbook_remove_person (AddressBookFile * book, ItemPerson * person)
{
  ItemPerson *item;
...
*/
ItemEMail *
addrbook_person_remove_email (AddressBookFile * book, ItemPerson * person, ItemEMail * email)
{
  ItemEMail *item;
...
ItemEMail *
addrbook_group_remove_email (AddressBookFile * book, ItemGroup * group, ItemEMail * email)
{
  ItemEMail *item;
...
*/
static void
addrbook_parse_address (AddressBookFile * book, XMLFile * file, ItemPerson * person)
{
  GList *attr;
  gchar *name, *value;
...
*/
static void
addrbook_parse_addr_list (AddressBookFile * book, XMLFile * file, ItemPerson * person)
{
  GList *attr;
  guint prev_level;
...
*/
static void
addrbook_parse_attribute (XMLFile * file, ItemPerson * person)
{
  GList *attr;
  gchar *name, *value;
  gchar *element;
...
*/
static void
addrbook_parse_attr_list (AddressBookFile * book, XMLFile * file, ItemPerson * person)
{
  GList *attr;
  guint prev_level;
...
*/
static void
addrbook_parse_person (AddressBookFile * book, XMLFile * file)
{
  GList *attr;
  gchar *name, *value;
...
*/
static void
addrbook_parse_member (AddressBookFile * book, XMLFile * file, ItemGroup * group)
{
  GList *attr;
  gchar *name, *value;
...
*/
static void
addrbook_parse_member_list (AddressBookFile * book, XMLFile * file, ItemGroup * group)
{
  GList *attr;
  guint prev_level;
...
*/
static void
addrbook_parse_group (AddressBookFile * book, XMLFile * file)
{
  GList *attr;
  gchar *name, *value;
...
*/
static void
addrbook_parse_folder_item (AddressBookFile * book, XMLFile * file, ItemFolder * folder)
{
  GList *attr;
  gchar *name, *value;
  gchar *uid = NULL;
...
*/
static void
addrbook_parse_folder_list (AddressBookFile * book, XMLFile * file, ItemFolder * folder)
{
  GList *attr;
  guint prev_level;
...
*/
static void
addrbook_parse_folder (AddressBookFile * book, XMLFile * file)
{
  GList *attr;
  gchar *name, *value;
...
*/
static gboolean
addrbook_read_tree (AddressBookFile * book, XMLFile * file)
{
  gboolean retVal;
  GList *attr;
  gchar *name, *value;
...
*/
static void
addrbook_res_items_vis (gpointer key, gpointer value, gpointer data)
{
...
*/
static void
addrbook_resolve_folder_items (AddressBookFile * book)
{
...
*/
gint
addrbook_read_data (AddressBookFile * book)
{
  XMLFile *file = NULL;
  gchar *fileSpec = NULL;
...
static void
addrbook_write_elem_s (FILE * fp, gint lvl, gchar * name)
{
  gint i;
  for (i = 0; i < lvl; i++)
    fputs ("  ", fp);
...
static void
addrbook_write_elem_e (FILE * fp, gint lvl, gchar * name)
{
  gint i;
  for (i = 0; i < lvl; i++)
    fputs ("  ", fp);
...
static void
addrbook_write_attr (FILE * fp, gchar * name, gchar * value)
{
  fputs (" ", fp);
  fputs (name, fp);
  fputs ("=\"", fp);
...
*/
static void
addrbook_write_item_person_vis (gpointer key, gpointer value, gpointer data)
{
  AddrItemObject *obj = (AddrItemObject *) value;
  FILE *fp = (FILE *) data;
  GList *node;
...
*/
static void
addrbook_write_item_group_vis (gpointer key, gpointer value, gpointer data)
{
  AddrItemObject *obj = (AddrItemObject *) value;
  FILE *fp = (FILE *) data;
  GList *node;
...
*/
static void
addrbook_write_item_folder_vis (gpointer key, gpointer value, gpointer data)
{
  AddrItemObject *obj = (AddrItemObject *) value;
  FILE *fp = (FILE *) data;
  GList *node;
...
*/
gint
addrbook_write_to (AddressBookFile * book, gchar * newFile)
{
  FILE *fp;
  gchar *fileSpec;
#ifndef DEV_STANDALONE
...
*/
gint
addrbook_save_data (AddressBookFile * book)
{
  g_return_val_if_fail (book != NULL, -1);
...
*/
ItemEMail *
addrbook_move_email_before (AddressBookFile * book, ItemPerson * person, ItemEMail * itemMove, ItemEMail * itemTarget)
{
  ItemEMail *email = NULL;
...
*/
ItemEMail *
addrbook_move_email_after (AddressBookFile * book, ItemPerson * person, ItemEMail * itemMove, ItemEMail * itemTarget)
{
  ItemEMail *email = NULL;
...
*/
static gboolean
addrbook_free_simple_hash_vis (gpointer * key, gpointer * value, gpointer * data)
{
  g_free (key);
  key = NULL;
  value = NULL;
...
*/
void
addrbook_update_address_list (AddressBookFile * book, ItemPerson * person, GList * listEMail)
{
  GList *node;
  GList *oldData;
  GList *listGroup;
...
*/
ItemPerson *
addrbook_add_address_list (AddressBookFile * book, ItemFolder * folder, GList * listEMail)
{
  ItemPerson *person;
  ItemFolder *f = folder;
  GList *node;
...
*/
static void
addrbook_load_hash_table_email_vis (gpointer key, gpointer value, gpointer data)
{
  AddrItemObject *obj = (AddrItemObject *) value;
...
*/
static void
addrbook_load_hash_table_email (AddressBookFile * book, GHashTable * table)
{
  g_return_if_fail (book != NULL);
...
*/
static void
addrbook_build_avail_email_vis (gpointer key, gpointer value, gpointer data)
{
  AddrItemObject *obj = (AddrItemObject *) value;
...
*/
GList *
addrbook_get_available_email_list (AddressBookFile * book, ItemGroup * group)
{
  GList *list = NULL;
  GHashTable *table;
...
*/
void
addrbook_update_group_list (AddressBookFile * book, ItemGroup * group, GList * listEMail)
{
  GList *oldData;
...
*/
ItemGroup *
addrbook_add_group_list (AddressBookFile * book, ItemFolder * folder, GList * listEMail)
{
  ItemGroup *group = NULL;
  ItemFolder *f = folder;
...
*/
ItemFolder *
addrbook_add_new_folder (AddressBookFile * book, ItemFolder * parent)
{
  ItemFolder *folder = NULL;
  ItemFolder *p = parent;
...
*/
void
addrbook_update_attrib_list (AddressBookFile * book, ItemPerson * person, GList * listAttrib)
{
  GList *node;
  GList *oldData;
...
*/
void
addrbook_add_attrib_list (AddressBookFile * book, ItemPerson * person, GList * listAttrib)
{
  GList *node;
...
*/
AddressBookFile *
addrbook_item_get_bookfile (AddrItemObject * aio)
{
...
*/
ItemFolder *
addrbook_remove_folder (AddressBookFile * book, ItemFolder * folder)
{
  ItemFolder *f;
...
*/
ItemFolder *
addrbook_remove_folder_delete (AddressBookFile * book, ItemFolder * folder)
{
  ItemFolder *f;
...
*/
GList *
addrbook_get_bookfile_list (AddressBookFile * book)
{
  gchar *adbookdir;
  GDir *dir;
...
#if 0
static void
addrbook_show_attribs (GList * attr)
{
  while (attr)
    {
...
*/
static void
addrbook_chkparse_addr_list (AddressBookFile * book, XMLFile * file)
{
  guint prev_level;
  GList *attr;
...
*/
static void
addrbook_chkparse_attribute (AddressBookFile * book, XMLFile * file)
{
  GList *attr;
  gchar *element;
...
*/
static void
addrbook_chkparse_attr_list (AddressBookFile * book, XMLFile * file)
{
  guint prev_level;
...
*/
static void
addrbook_chkparse_person (AddressBookFile * book, XMLFile * file)
{
  GList *attr;
...
*/
static void
addrbook_chkparse_member_list (AddressBookFile * book, XMLFile * file)
{
  GList *attr;
  guint prev_level;
...
*/
static void
addrbook_chkparse_group (AddressBookFile * book, XMLFile * file)
{
  GList *attr;
...
*/
static void
addrbook_chkparse_folder_list (AddressBookFile * book, XMLFile * file)
{
  GList *attr;
  guint prev_level;
...
*/
static void
addrbook_chkparse_folder (AddressBookFile * book, XMLFile * file)
{
  GList *attr;
...
*/
static gboolean
addrbook_chkread_tree (AddressBookFile * book, XMLFile * file)
{
  GList *attr;
  gboolean retVal;
...
*/
gint
addrbook_test_read_file (AddressBookFile * book, gchar * fileName)
{
  XMLFile *file = NULL;
  gchar *fileSpec = NULL;
...
*/
GList *
addrbook_get_all_persons (AddressBookFile * book)
{
  g_return_val_if_fail (book != NULL, NULL);
...
*/
ItemPerson *
addrbook_add_contact (AddressBookFile * book, ItemFolder * folder, const gchar * name,
