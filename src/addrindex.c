...
#if 0
N_("Common address") N_("Personal address")
#endif
...
*/
     static AddressInterface *
     addrindex_create_interface (gint type, gchar * name, gchar * tagIf, gchar * tagDS)
{
...
*/
static void
addrindex_build_if_list (AddressIndex * addrIndex)
{
...
*/
static void
addrindex_free_attributes (GList * list)
{
  GList *node = list;
  while (node)
    {
...
*/
void
addrindex_free_datasource (AddressIndex * addrIndex, AddressDataSource * ds)
{
...
static void
addrindex_free_all_datasources (AddressInterface * iface)
{
...
static void
addrindex_free_interface (AddressInterface * iface)
{
...
*/
void
addrindex_set_file_path (AddressIndex * addrIndex, const gchar * value)
{
  g_return_if_fail (addrIndex != NULL);
...
void
addrindex_set_file_name (AddressIndex * addrIndex, const gchar * value)
{
  g_return_if_fail (addrIndex != NULL);
...
void
addrindex_set_dirty (AddressIndex * addrIndex, const gboolean value)
{
  g_return_if_fail (addrIndex != NULL);
...
*/
GList *
addrindex_get_interface_list (AddressIndex * addrIndex)
{
...
*/
void
addrindex_free_index (AddressIndex * addrIndex)
{
  GList *node;
...
*/
void
addrindex_print_index (AddressIndex * addrIndex, FILE * stream)
{
  g_return_if_fail (addrIndex != NULL);
...
*/
AddressInterface *
addrindex_get_interface (AddressIndex * addrIndex, AddressIfType ifType)
{
...
*/
AddressDataSource *
addrindex_index_add_datasource (AddressIndex * addrIndex, AddressIfType ifType, gpointer dataSource)
{
  AddressInterface *iface;
  AddressDataSource *ds = NULL;
...
*/
AddressDataSource *
addrindex_index_remove_datasource (AddressIndex * addrIndex, AddressDataSource * dataSource)
{
...
static AddressInterface *
addrindex_tag_get_interface (AddressIndex * addrIndex, gchar * tag, AddressIfType ifType)
{
  AddressInterface *retVal = NULL;
...
static AddressInterface *
addrindex_tag_get_datasource (AddressIndex * addrIndex, AddressIfType ifType, gchar * tag)
{
  AddressInterface *retVal = NULL;
  GList *node = addrIndex->interfaceList;
...
static void
addrindex_write_elem_s (FILE * fp, gint lvl, gchar * name)
{
  gint i;
  for (i = 0; i < lvl; i++)
    fputs ("  ", fp);
...
static void
addrindex_write_elem_e (FILE * fp, gint lvl, gchar * name)
{
  gint i;
  for (i = 0; i < lvl; i++)
    fputs ("  ", fp);
...
static void
addrindex_write_attr (FILE * fp, gchar * name, gchar * value)
{
  fputs (" ", fp);
  fputs (name, fp);
  fputs ("=\"", fp);
...
*/
static GList *
addrindex_read_attributes (XMLFile * file)
{
  GList *list = NULL;
  AddressIfAttrib *nv;
  GList *attr;
...
*/
static void
addrindex_write_attributes (FILE * fp, gchar * tag, GList * list, gint lvl)
{
  GList *node;
  AddressIfAttrib *nv;
  if (list)
...
#if 0
static void
addrindex_print_attributes (GList * list, FILE * stream)
{
  GList *node = list;
  while (node)
    {
...
addrindex_parse_book (XMLFile * file)
{
...
static void
addrindex_write_book (FILE * fp, AddressDataSource * ds, gint lvl)
{
  AddressBookFile *abf = ds->rawDataSource;
  if (abf)
    {
...
static AddressDataSource *
addrindex_parse_vcard (XMLFile * file)
{
  AddressDataSource *ds = g_new0 (AddressDataSource, 1);
  VCardFile *vcf;
  GList *attr;
...
static void
addrindex_write_vcard (FILE * fp, AddressDataSource * ds, gint lvl)
{
  VCardFile *vcf = ds->rawDataSource;
  if (vcf)
    {
...
#ifdef USE_LDAP
static AddressDataSource *
addrindex_parse_ldap (XMLFile * file)
{
  AddressDataSource *ds = g_new0 (AddressDataSource, 1);
  SyldapServer *server;
  GList *attr;
...
static void
addrindex_write_ldap (FILE * fp, AddressDataSource * ds, gint lvl)
{
  SyldapServer *server = ds->rawDataSource;
  if (server)
    {
...
*/
static void
addrindex_read_index (AddressIndex * addrIndex, XMLFile * file)
{
  guint prev_level;
  /* gchar *element; */
  /* GList *attr; */
...
static gint
addrindex_read_file (AddressIndex * addrIndex)
{
  XMLFile *file = NULL;
  gchar *fileSpec = NULL;
...
static void
addrindex_write_index (AddressIndex * addrIndex, FILE * fp)
{
  GList *nodeIF, *nodeDS;
  gint lvlList = 1;
...
*/
gint
addrindex_write_to (AddressIndex * addrIndex, const gchar * newFile)
{
  FILE *fp;
  gchar *fileSpec;
#ifndef DEV_STANDALONE
...
*/
gint
addrindex_save_data (AddressIndex * addrIndex)
{
  g_return_val_if_fail (addrIndex != NULL, -1);
...
*/
gint
addrindex_save_all_books (AddressIndex * addrIndex)
{
...
*/
static AddressCvtNode *
addrindex_parse_item (XMLFile * file)
{
  gchar *element;
  guint level;
  AddressCvtNode *nn;
...
*/
static AddressCvtNode *
addrindex_add_object (AddressCvtNode * node, gint type, gchar * name, gchar * addr, char *rem)
{
  AddressCvtNode *nn;
  nn = g_new0 (AddressCvtNode, 1);
  nn->type = type;
...
*/
static void
addrindex_add_obj (XMLFile * file, AddressCvtNode * node)
{
  GList *attr;
  guint prev_level;
...
*/
static void
addrindex_consume_tree (XMLFile * file)
{
  guint prev_level;
  gchar *element;
  GList *attr;
...
*/
static void
addrindex_print_node (AddressCvtNode * node, FILE * stream)
{
  GList *list;
...
*/
static void
addrindex_free_node (AddressCvtNode * node)
{
...
*/
static void
addrindex_process_node (AddressBookFile * abf, AddressCvtNode * node, ItemFolder * parent,
...
*/
static gboolean
addrindex_process_book (AddressIndex * addrIndex, XMLFile * file, gchar * displayName)
{
...
*/
static void
addrindex_convert_tree (AddressIndex * addrIndex, XMLFile * file)
{
  guint prev_level;
  gchar *element;
  GList *attr;
...
static gint
addrindex_convert_data (AddressIndex * addrIndex)
{
  XMLFile *file = NULL;
  gchar *fileSpec;
...
*/
static gboolean
addrindex_create_new_book (AddressIndex * addrIndex, gchar * displayName)
{
  gboolean retVal = FALSE;
  AddressBookFile *abf = NULL;
  gchar *newFile = NULL;
...
*/
gint
addrindex_read_data (AddressIndex * addrIndex)
{
  g_return_val_if_fail (addrIndex != NULL, -1);
...
*/
gint
addrindex_create_new_books (AddressIndex * addrIndex)
{
  gboolean flg;
...
gint
addrindex_create_extra_books (AddressIndex * addrIndex)
{
  GList *node_ds;
  AddressInterface *iface = NULL;
  AddressDataSource *ds = NULL;
 ...
 */
gboolean
addrindex_ds_get_modify_flag (AddressDataSource * ds)
{
  gboolean retVal = FALSE;
  AddressInterface *iface;
 ...
 */
gboolean
addrindex_ds_get_access_flag (AddressDataSource * ds)
{
  gboolean retVal = FALSE;
  AddressInterface *iface;
 ...
 */
gboolean
addrindex_ds_get_read_flag (AddressDataSource * ds)
{
 ...
 */
gint
addrindex_ds_get_status_code (AddressDataSource * ds)
{
  gint retVal = MGU_SUCCESS;
  AddressInterface *iface;
 ...
 */
gint
addrindex_ds_read_data (AddressDataSource * ds)
{
  gint retVal = MGU_SUCCESS;
  AddressInterface *iface;
 ...
 */
ItemFolder *
addrindex_ds_get_root_folder (AddressDataSource * ds)
{
 ...
 */
GList *
addrindex_ds_get_list_folder (AddressDataSource * ds)
{
  GList *retVal = FALSE;
  AddressInterface *iface;
 ...
 */
GList *
addrindex_ds_get_list_person (AddressDataSource * ds)
{
  GList *retVal = FALSE;
  AddressInterface *iface;
 ...
 */
gchar *
addrindex_ds_get_name (AddressDataSource * ds)
{
  gchar *retVal = FALSE;
  AddressInterface *iface;
 ...
 */
void
addrindex_ds_set_access_flag (AddressDataSource * ds, gboolean * value)
{
  AddressInterface *iface;
 ...
 */
gboolean
addrindex_ds_get_readonly (AddressDataSource * ds)
{
  AddressInterface *iface;
  if (ds == NULL)
    return TRUE;
 ...
 */
GList *
addrindex_ds_get_all_persons (AddressDataSource * ds)
{
  GList *retVal = NULL;
  AddressInterface *iface;
 ...
 */
GList *
addrindex_ds_get_all_groups (AddressDataSource * ds)
{
  GList *retVal = NULL;
  AddressInterface *iface;
