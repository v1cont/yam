...
#define PACK_FRAME_EXP(box, frame, label)                       \
  {                                                             \
	frame = gtk_frame_new(label);                               \
	gtk_widget_show(frame);                                     \
...
#if USE_GSPELL
void prefs_set_data_from_spellbtn (PrefParam * pparam);
void prefs_set_spellbtn (PrefParam * pparam);
#endif
