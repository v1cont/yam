...
void progress_dialog_set_row_pixbuf (ProgressDialog * progress, gint row, GdkPixbuf * pixbuf);
void progress_dialog_set_row_name (ProgressDialog * progress, gint row, const gchar * name);
void progress_dialog_set_row_status (ProgressDialog * progress, gint row, const gchar * status);
void progress_dialog_set_row_progress (ProgressDialog * progress, gint row, const gchar * progress_str);
