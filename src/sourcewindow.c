...
source_window_create (void)
{
  ...
  g_signal_connect (G_OBJECT (gtk_scrollable_get_vadjustment (GTK_SCROLLABLE (text))),
                    "value-changed", G_CALLBACK (adj_value_changed), sourcewin);
...
void
source_window_show (SourceWindow * sourcewin)
{
  gtk_widget_show_all (sourcewin->window);
}

void
source_window_destroy (SourceWindow * sourcewin)
{
...
void
source_window_show_msg (SourceWindow * sourcewin, MsgInfo * msginfo)
{
  gchar *file;
  gchar *title;
  FILE *fp;
...
void
source_window_append (SourceWindow * sourcewin, const gchar * str)
{
...
static void
source_window_size_alloc_cb (GtkWidget * widget, GtkAllocation * allocation)
{
...
static gint
source_window_delete_cb (GtkWidget * widget, GdkEventAny * event, SourceWindow * sourcewin)
{
...
static gboolean
key_pressed (GtkWidget * widget, GdkEventKey * event, SourceWindow * sourcewin)
{
...
static void
adj_value_changed (GtkAdjustment * adj, SourceWindow * sourcewin)
{
  GtkTextBuffer *buffer;
