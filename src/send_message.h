...
gint send_message_queue_all (FolderItem * queue, gboolean save_msgs, gboolean filter_msgs);

gint send_message_set_reply_flag (const gchar * reply_target, const gchar * msgid);
